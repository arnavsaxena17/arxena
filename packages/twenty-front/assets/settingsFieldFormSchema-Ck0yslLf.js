import{M as z,eX as x,L as M,a as y,dQ as _e,j as t,eY as se,eZ as xe,e_ as Ie,e$ as Pe,V as b,W as f,f0 as k,n as p,h as ae,aq as ce,X as j,f1 as ke,ar as U,as as E,at as je,ag as ze,ah as We,q as de,au as Be,aw as Me,f as Y,T as Ue,U as a,f2 as Ye,eu as ue,f3 as pe,aD as A,eN as ge,dD as I,cT as he,f4 as Ge,f5 as Xe,B as He,cW as qe,ai as me,f6 as Ke,f7 as Qe,d0 as Je,f8 as Ze,a0 as G,r as Q,f9 as Se,bD as v,bA as et,u as ye,a6 as s,fa as tt,bY as nt,fb as ot,c4 as lt,d1 as J,d4 as Z,d5 as ee,d2 as it,dw as rt,d3 as W,bb as st,ey as B,ez as at,aT as ct,aN as dt,R as ut,ex as pt,fc as gt,fd as ht,fe as te,ff as mt,a8 as St,dz as yt}from"./index-BzerUb1B.js";import{T as ft}from"./TextArea-DEwBENQ4.js";import{S as fe,a as be,b as Fe,c as Ce,d as we,e as De,f as bt}from"./SettingsOptionCardContentToggle-DerAz5c8.js";import{D as X}from"./DatabaseIdentifierMaximumLength-BqipT9z5.js";import{a as N,u as Ee,b as Te,c as P,d as Oe,s as Ft}from"./SettingsObjectNewFieldSelect-DhfjUYOj.js";import{I as Ve,a as Ct,b as wt,c as Dt,d as Et,e as Tt}from"./IconTextWrap-bSHVbU5O.js";import{S as O,d as Ot,e as Vt,a as Nt,R as H,s as Lt,m as vt}from"./SettingsDataModelFieldPreviewCard-DxBKJf7p.js";const At=e=>{if(!z(e))return x[0];const o=(x.findIndex(i=>i===e)+1)%x.length;return x[o]},$t={green:"Green",turquoise:"Turquoise",sky:"Sky",blue:"Blue",purple:"Purple",pink:"Pink",red:"Red",orange:"Orange",yellow:"Yellow",gray:"Gray"},Rt=({color:e,selected:n,className:o,onClick:i,disabled:r,hovered:u,variant:c="default"})=>{const l=M();return y(Pe,{onClick:i,className:o,selected:n,disabled:r,hovered:u,children:[y(_e,{children:[t(se,{colorName:e,variant:c}),t(xe,{children:$t[e]})]}),n&&t(Ie,{size:l.icon.size.md})]})},_t=X,xt=()=>k([]).pick({description:!0}),Eo=({disabled:e,fieldMetadataItem:n})=>{const{control:o}=b();return t(f,{name:"description",control:o,defaultValue:n==null?void 0:n.description,render:({field:{onChange:i,value:r}})=>t(ft,{placeholder:"Write a description",minRows:4,value:r??void 0,onChange:i,disabled:e})})},It=(e=[])=>k(e).pick({icon:!0,label:!0}).merge(k().pick({name:!0,isLabelSyncedWithName:!0}).partial()),ne=p.div`
  display: flex;
