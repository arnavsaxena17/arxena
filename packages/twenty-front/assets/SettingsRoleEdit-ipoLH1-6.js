import{L as ne,a as d,dQ as le,M as ae,j as t,af as B,dL as E,dR as ie,K as se,dS as oe,n,i,dT as _,d0 as re,dU as de,bb as H,dV as ce,dW as b,b as v,H as M,aq as pe,X as z,as as x,ad as F,bc as ge,bC as he,d3 as ue,r as C,dX as Se,aA as me,dY as ye,dZ as fe,d4 as be,dw as Ie,Y as G,d_ as Re,ac as K,d1 as Te,R as Ce,d$ as xe,d6 as Ae,d5 as $e,B as Ne,ai as ve,ag as _e,ah as ke,e0 as Pe,t as N,$ as Ee,ce as Me,e1 as De,e2 as Oe,s as W,cf as we}from"./index-DB0OKRlD.js";import{S as je}from"./SettingsPageContainer-C2QLAmOr.js";import{S as Le}from"./SubMenuTopBarContainer-9LB8hreq.js";import{T as R,S as A,a as I}from"./Table-cIS0B5sH.js";import{S}from"./TableHeader-DXVgF--L.js";import{T as We}from"./TextArea-DKo5tlzu.js";import{S as Ue}from"./SettingsCard-CiBwey5e.js";import{I as Be}from"./IconUserPlus-D_tKCYgT.js";import{I as He}from"./IconLockOpen-DcWfx3pk.js";const ze=({accent:e="default",className:l,iconButtons:r,isIconDisplayedOnHoverOnly:o=!0,onClick:a,onMouseEnter:p,onMouseLeave:g,testId:h,avatar:c,hasSubMenu:m=!1,text:k})=>{const $=ne(),T=Array.isArray(r)&&r.length>0;return d(oe,{"data-testid":h??void 0,onClick:y=>{a&&(y.preventDefault(),y.stopPropagation(),a==null||a(y))},className:l,accent:e,isIconDisplayedOnHoverOnly:o,onMouseEnter:p,onMouseLeave:g,children:[d(le,{children:[ae(c)&&t(B,{placeholder:c.placeholder,avatarUrl:c.avatarUrl,placeholderColorSeed:c.placeholderColorSeed,size:c.size,type:c.type}),t(E,{text:k??""})]}),t("div",{className:"hoverable-buttons",children:T&&t(ie,{iconButtons:r,size:"small"})}),m&&t(se,{size:$.icon.size.sm,color:$.font.color.tertiary})]})},Fe=n(R)`
  display: flex;
`,Ge=n(S)`
  flex: 1;
`,Ke=n(S)`
