import{U as e,n as d,V as u,j as t,W as b,X as g}from"./index-DB0OKRlD.js";const S=e.object({dbname:e.string().min(1),host:e.string().min(1),port:e.preprocess(a=>parseInt(a),e.number().positive()),user:e.string().min(1),password:e.string().min(1),schema:e.string().min(1),label:e.string().min(1)}),w=e.object({api_key:e.string().min(1),label:e.string().min(1)}),h=d.div`
  display: grid;
