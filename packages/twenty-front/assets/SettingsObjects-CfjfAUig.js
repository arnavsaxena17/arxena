import{aK as k,aM as $,aL as B,cZ as z,aZ as R,c_ as F,n as d,L as _,bA as H,a as u,j as a,q as Q,h as A,c$ as U,d0 as G,t as h,d1 as Z,c4 as q,d2 as J,d3 as S,bb as K,d4 as V,d5 as W,K as Y,X,r as b,a0 as ee,bn as te,s as O,B as ae,ai as ne,T as j,b as oe,H as le,d6 as ie,D as v,as as se}from"./index-DB0OKRlD.js";import{D as re}from"./mutations-DP4kqy4g.js";import{u as ce,a as w,S as de,T as L}from"./useSortedArray-DGYebcwO.js";import{S as ue}from"./SettingsPageContainer-C2QLAmOr.js";import{g as T,S as me}from"./getObjectTypeLabel-D2SyX39N.js";import{T as be,a as g,S as pe}from"./Table-cIS0B5sH.js";import{I as ge}from"./IconArchiveOff-Ur8FfoSO.js";import{S as fe}from"./SubMenuTopBarContainer-9LB8hreq.js";import{S as he}from"./TableHeader-DXVgF--L.js";import"./TableBody-LZo7nNIH.js";const ye=()=>{const e=k(),[n]=$(re,{client:e}),{refreshObjectMetadataItems:i}=B("network-only");return{deleteOneObjectMetadataItem:async l=>{const s=await n({variables:{idToDelete:l}});return await i(),s}}},Ce=({objectMetadataItems:e,skip:n=!1})=>{const i=e.map(r=>({objectNameSingular:r.nameSingular,variables:{},fields:{id:!0}})),o=z({operationSignatures:i}),{data:l}=R(o??F,{skip:n});return{totalCountByObjectMetadataItemNamePlural:Object.fromEntries(Object.entries(l??{}).map(([r,c])=>[r,c.totalCount]))}},P=d(be)`
