import{r as m,b2 as F,b3 as b,R as p,b4 as P,b5 as S,M as g,n as h,j as s,a as y,as as L,q as k,s as C,t as f}from"./index-BzerUb1B.js";import{S as x}from"./SettingsPageContainer-VijhEKua.js";import{S as E}from"./SettingsOptionCardContentToggle-DerAz5c8.js";import{S as v}from"./SubMenuTopBarContainer-DvhK9_Ug.js";const w=()=>{const[r,i]=m.useState(null),[t,o]=F(b),l=p(P),[d]=S({onCompleted:e=>{var a;if(g(t)){const n=e.updateLabPublicFeatureFlag;o({...t,featureFlags:[...((a=t.featureFlags)==null?void 0:a.filter(c=>c.key!==n.key))??[],{...n,workspaceId:t.id}]})}},onError:e=>{i(e.message)}}),u=async(e,a)=>g(t)?(i(null),!!(await d({variables:{input:{publicFeatureFlag:e,value:a}}})).data):(i("No workspace selected"),!1);return{labPublicFeatureFlags:l.map(e=>{var a,n;return{...e,value:((n=(a=t==null?void 0:t.featureFlags)==null?void 0:a.find(c=>c.key===e.key))==null?void 0:n.value)??!1}}),handleLabPublicFeatureFlagUpdate:u,error:r}},I=h.div`
  display: grid;
