...
import {
  GET_LINKEDIN_UNIPILE_HEALTH_STATUS,
  GET_LINKEDIN_UNIPILE_SESSION_STATS,
} from '../graphql/queries/getLinkedInUnipileMonitoring';
import {
  GET_WHATSAPP_HEALTH_STATUS,
  GET_WHATSAPP_SESSION_STATS,
} from '../graphql/queries/getWhatsAppHealthStatus';
...
export const SettingsAdminWhatsAppMonitoring = () => {
  ...
  const [loadLinkedInUnipileHealthStatus] = useLazyQuery(
    GET_LINKEDIN_UNIPILE_HEALTH_STATUS,
    {
      client: apolloAdminClient,
      fetchPolicy: 'network-only',
  ...
  const [loadLinkedInUnipileSessionStats] = useLazyQuery(
    GET_LINKEDIN_UNIPILE_SESSION_STATS,
    {
      client: apolloAdminClient,
      fetchPolicy: 'network-only',
