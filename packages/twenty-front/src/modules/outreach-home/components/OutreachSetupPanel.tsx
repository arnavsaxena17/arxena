...
const OUTREACH_SEND_TIMEZONE_OPTIONS = Object.values(
...
export const OutreachSetupPanel = ({
  ...
  return (
    <StyledPanel>
      <StyledSection>
        <StyledTitle>Your company</StyledTitle>
        <StyledMetaRow>
          <StyledSellerName>
        ...
        <StyledScheduleRow>
          <StyledFieldStack>
            ...
            <StyledSelect
              ...
              disabled={!hasProject}
              onChange={(event) =>
                setSendModeDraft(event.target.value as OutreachSendMode)
              }
            >
