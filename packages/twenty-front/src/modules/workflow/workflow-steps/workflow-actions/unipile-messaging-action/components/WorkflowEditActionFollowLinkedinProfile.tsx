...
import { type WorkflowFollowLinkedinProfileAction } from '@/workflow/types/Workflow';
...
type WorkflowEditActionFollowLinkedinProfileProps = {
  action: WorkflowFollowLinkedinProfileAction;
  actionOptions:
    | {
        readonly: true;
      }
    | {
        readonly?: false;
        onActionUpdate: (action: WorkflowFollowLinkedinProfileAction) => void;
      };
};

export const WorkflowEditActionFollowLinkedinProfile = ({
  action,
  actionOptions,
}: WorkflowEditActionFollowLinkedinProfileProps) => {
