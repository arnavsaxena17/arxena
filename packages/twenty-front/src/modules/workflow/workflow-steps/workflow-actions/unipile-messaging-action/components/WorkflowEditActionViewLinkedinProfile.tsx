...
import { type WorkflowViewLinkedinProfileAction } from '@/workflow/types/Workflow';
...
type WorkflowEditActionViewLinkedinProfileProps = {
  action: WorkflowViewLinkedinProfileAction;
  actionOptions:
    | {
        readonly: true;
      }
    | {
        readonly?: false;
        onActionUpdate: (action: WorkflowViewLinkedinProfileAction) => void;
      };
};

export const WorkflowEditActionViewLinkedinProfile = ({
  action,
  actionOptions,
}: WorkflowEditActionViewLinkedinProfileProps) => {
