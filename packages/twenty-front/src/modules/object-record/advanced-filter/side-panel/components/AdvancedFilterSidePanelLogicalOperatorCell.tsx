import { AdvancedFilterRecordFilterGroupLogicalOperatorDropdown } from '@/object-record/advanced-filter/components/AdvancedFilterRecordFilterGroupLogicalOperatorDropdown';
    ...
    <StyledContainer>
      {index === 0 ? (
        ...
        readonly ? (
          ...
          <AdvancedFilterRecordFilterGroupLogicalOperatorDropdown
            recordFilterGroup={recordFilterGroup}
          />
        )
      ) : (
