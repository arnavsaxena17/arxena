...
import { RecordTableCellContainer } from '@/object-record/job-table/record-table-cell/components/RecordTableCellContainer';
import { HotkeyScope } from '@/ui/utilities/hotkey/types/HotkeyScope';

export const RecordTableCell = ({ customHotkeyScope }: { customHotkeyScope: HotkeyScope }) => {
  const { onUpsertRecord, onMoveFocus, onCloseTableCell } = useContext(RecordTableContext);
