...
export const useCloseRecordTableCellV2 = (recordTableScopeId: string) => {
  ...
  const closeCurrentTableCellInEditMode = useCloseCurrentTableCellInEditMode(recordTableScopeId);

  const resetRecordTablePendingRecordId = useResetRecoilState(pendingRecordIdState);
