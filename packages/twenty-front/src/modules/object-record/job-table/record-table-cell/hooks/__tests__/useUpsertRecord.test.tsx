...
import { useUpsertRecord } from '@/object-record/job-table/record-table-cell/hooks/useUpsertRecord';
...
jest.mock('@/object-record/record-field/hooks/internal/useRecordFieldInputStates', () => ({
  __esModule: true,
...
const Wrapper = ({ children, pendingRecordIdMockedValue, draftValueMockedValue }: { children: ReactNode; pendingRecordIdMockedValue: string | null; draftValueMockedValue: string | null }) => (
  <RecoilRoot
