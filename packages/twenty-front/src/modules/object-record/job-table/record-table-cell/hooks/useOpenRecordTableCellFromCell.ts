...
import { CellHotkeyScopeContext } from '@/object-record/job-table/contexts/CellHotkeyScopeContext';
...
export const useOpenRecordTableCellFromCell = () => {
  ...
  const openTableCell = (initialValue?: string, isActionButtonClick = false) => {
    onOpenTableCell({
      cellPosition,
