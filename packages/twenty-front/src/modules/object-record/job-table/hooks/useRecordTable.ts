...
import { useGetIsSomeCellInEditModeState } from '@/object-record/job-table/hooks/internal/useGetIsSomeCellInEditMode';
import { useRecordTableStates } from '@/object-record/job-table/hooks/internal/useRecordTableStates';
import { useSetHasUserSelectedAllRows } from '@/object-record/job-table/hooks/internal/useSetAllRowSelectedState';
...
export const useRecordTable = (props?: useRecordTableProps) => {
  ...
  const setRecordTableLastRowVisible = useSetRecoilState(tableLastRowVisibleState);
