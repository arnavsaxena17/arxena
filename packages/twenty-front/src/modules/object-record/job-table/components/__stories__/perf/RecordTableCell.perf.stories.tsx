...
import { RecordFieldValueSelectorContextProvider, useSetRecordValue } from '@/object-record/record-store/contexts/RecordFieldValueSelectorContext';
...
const RelationFieldValueSetterEffect = () => {
  const setEntity = useSetRecoilState(recordStoreFamilyState(mockPerformance.entityId));

  const setRelationEntity = useSetRecoilState(recordStoreFamilyState(mockPerformance.relationEntityId));
  ...
  useEffect(() => {
    ...
    setRecordValue(mockPerformance.relationFieldValue.id, mockPerformance.relationFieldValue);
          ...
          <RecordTableContext.Provider
            ...
            <RecordTableScope recordTableScopeId="asd" onColumnsChange={() => {}}>
              <RecordTableRowContext.Provider
                value={{
                  objectNameSingular: mockPerformance.entityValue.__typename.toLocaleLowerCase(),
