...
import { RecordTable } from '@/object-record/job-table/components/RecordTable';
import { RecordTableEmptyState } from '@/object-record/job-table/components/RecordTableEmptyState';
import { EntityDeleteContext } from '@/object-record/job-table/contexts/EntityDeleteHookContext';
...
export const RecordTableWithWrappers = ({ updateRecordMutation, createRecord, objectNameSingular, recordTableId, viewBarId }: RecordTableWithWrappersProps) => {
