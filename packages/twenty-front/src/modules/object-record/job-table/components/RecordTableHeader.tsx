...
import { RecordTableHeaderCell } from '@/object-record/job-table/components/RecordTableHeaderCell';
...
export const RecordTableHeader = ({ createRecord }: { createRecord: () => void }) => {
