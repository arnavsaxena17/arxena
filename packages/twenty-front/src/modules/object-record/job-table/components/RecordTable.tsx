...
import { RecordTableBody } from '@/object-record/job-table/components/RecordTableBody';
import { RecordTableBodyEffect } from '@/object-record/job-table/components/RecordTableBodyEffect';
import { RecordTableHeader } from '@/object-record/job-table/components/RecordTableHeader';
import { RecordTableContext } from '@/object-record/job-table/contexts/RecordTableContext';
import { useHandleContainerMouseEnter } from '@/object-record/job-table/hooks/internal/useHandleContainerMouseEnter';
import { useRecordTableStates } from '@/object-record/job-table/hooks/internal/useRecordTableStates';
import { useRecordTableMoveFocus } from '@/object-record/job-table/hooks/useRecordTableMoveFocus';
import { useCloseRecordTableCellV2 } from '@/object-record/job-table/record-table-cell/hooks/useCloseRecordTableCellV2';
import { useMoveSoftFocusToCellOnHoverV2 } from '@/object-record/job-table/record-table-cell/hooks/useMoveSoftFocusToCellOnHoverV2';
import { OpenTableCellArgs, useOpenRecordTableCellV2 } from '@/object-record/job-table/record-table-cell/hooks/useOpenRecordTableCellV2';
import { useTriggerContextMenu } from '@/object-record/job-table/record-table-cell/hooks/useTriggerContextMenu';
import { useUpsertRecordV2 } from '@/object-record/job-table/record-table-cell/hooks/useUpsertRecordV2';
import { RecordTableScope } from '@/object-record/job-table/scopes/RecordTableScope';
import { MoveFocusDirection } from '@/object-record/job-table/types/MoveFocusDirection';
...
export const RecordTable = ({ recordTableId, objectNameSingular, onColumnsChange, createRecord }: RecordTableProps) => {
      ...
      {!!objectNameSingular && (
        <RecordTableContext.Provider
          ...
          <StyledTable className="entity-table-cell">
            ...
            <RecordTableBody objectNameSingular={objectNameSingular} recordTableId={recordTableId} />
          </StyledTable>
        </RecordTableContext.Provider>
      )}
    </RecordTableScope>
