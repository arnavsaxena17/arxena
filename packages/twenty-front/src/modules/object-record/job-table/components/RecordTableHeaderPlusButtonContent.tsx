...
import { useTableColumns } from '@/object-record/job-table/hooks/useTableColumns';
...
export const RecordTableHeaderPlusButtonContent = () => {
  ...
  return (
    <>
        ...
        <>
          <DropdownMenuItemsContainer>
            {hiddenTableColumns.map(column => (
              <MenuItem key={column.fieldMetadataId} onClick={() => handleAddColumn(column)} LeftIcon={getIcon(column.iconName)} text={column.label} />
            ))}
          </DropdownMenuItemsContainer>
      ...
      <DropdownMenuItemsContainer>
        <StyledMenuItemLink to={`/settings/objects/${objectMetadataItem.namePlural}`}>
