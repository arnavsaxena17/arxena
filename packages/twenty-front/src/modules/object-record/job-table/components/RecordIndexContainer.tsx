...
type RecordIndexContainerJobProps = {
  recordIndexId: string;
  objectNamePlural: string;
  createRecord: () => Promise<void>;
  record: any; //! change any
};

export const RecordIndexContainer = ({ createRecord, recordIndexId, objectNamePlural, record }: RecordIndexContainerJobProps) => {
  ...
  console.log('RecordIndexContainerJob', objectNamePlural, objectNameSingular, recordIndexId, recordIndexViewType);
  const { objectMetadataItem } = useObjectMetadataItem({
    objectNameSingular,
  });

  console.log('RecordIndexContainerJob', objectMetadataItem);
