...
import { RecordUpdateContext } from '@/object-record/job-table/contexts/EntityUpdateMutationHookContext';
...
import { RecordTableCell } from '@/object-record/job-table/record-table-cell/components/RecordTableCell';
...
export const RecordTableCellFieldContextWrapper = () => {
  ...
  const customHotkeyScope = isFieldRelation(columnDefinition) ? RelationPickerHotkeyScope.RelationPicker : isFieldSelect(columnDefinition) ? SelectFieldHotkeyScope.SelectField : TableHotkeyScope.CellEditMode;
