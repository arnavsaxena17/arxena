...
import { HandleContainerMouseEnterArgs } from '@/object-record/job-table/hooks/internal/useHandleContainerMouseEnter';
import { OpenTableCellArgs } from '@/object-record/job-table/record-table-cell/hooks/useOpenRecordTableCellV2';
...
export type RecordTableContextProps = {
  ...
  onUpsertRecord: ({ persistField, entityId, fieldName }: { persistField: () => void; entityId: string; fieldName: string }) => void;
...
export const RecordTableContext = createContext<RecordTableContextProps>({} as RecordTableContextProps);
