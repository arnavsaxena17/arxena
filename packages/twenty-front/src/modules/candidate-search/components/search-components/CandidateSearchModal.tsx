...
import { ModalContainer } from '@/candidate-search/components/AIChatAssistant/ModalContainer';
import { ModalHeader } from '@/candidate-search/components/AIChatAssistant/ModalHeader';
