...
const testCases = [
  ...
  { loc: AppPath.ConnectLinkedin, isLogged: true, subscriptionStatus: undefined, onboardingStatus: OnboardingStatus.PLAN_REQUIRED, res: true },
  { loc: AppPath.ConnectLinkedin, isLogged: true, subscriptionStatus: SubscriptionStatus.Canceled, onboardingStatus: OnboardingStatus.COMPLETED, res: false },
  { loc: AppPath.ConnectLinkedin, isLogged: true, subscriptionStatus: SubscriptionStatus.Unpaid, onboardingStatus: OnboardingStatus.COMPLETED, res: false },
  { loc: AppPath.ConnectLinkedin, isLogged: true, subscriptionStatus: SubscriptionStatus.PastDue, onboardingStatus: OnboardingStatus.COMPLETED, res: false },
  { loc: AppPath.ConnectLinkedin, isLogged: false, subscriptionStatus: undefined, onboardingStatus: undefined, res: true },
