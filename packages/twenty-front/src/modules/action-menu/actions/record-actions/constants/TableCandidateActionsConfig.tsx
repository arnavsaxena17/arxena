...
> = {
  ...
  //   key: CandidateActionKeys.BULK_MESSAGE,
  ...
  //   type: ActionMenuEntryType.Standard,
  //   scope: ActionMenuEntryScope.RecordSelection,
  //   key: CandidateActionKeys.VIEW_ATTACHMENTS,
  ...
  //   type: ActionMenuEntryType.Standard,
  //   scope: ActionMenuEntryScope.RecordSelection,
  //   key: CandidateActionKeys.CREATE_SHORTLIST,
  ...
  //   type: ActionMenuEntryType.Standard,
  //   scope: ActionMenuEntryScope.RecordSelection,
  //   key: CandidateActionKeys.UPDATE_STATUS,
  ...
  checkContactAvailability: {
    type: ActionMenuEntryType.Standard,
    scope: ActionMenuEntryScope.RecordSelection,
    key: MultipleRecordsActionKeys.CHECK_CONTACT_AVAILABILITY,
    label: msg`Check Contact Availability`,
    shortLabel: msg`Check Availability`,
    position: 10,
    Icon: IconMail,
    accent: 'placeholder',
    isPinned: false,
    ...
    useAction: useCheckContactAvailabilityAction,
  },

  fetchContactDetails: {
    type: ActionMenuEntryType.Standard,
    scope: ActionMenuEntryScope.RecordSelection,
    key: MultipleRecordsActionKeys.FETCH_CONTACT_DETAILS,
    label: msg`Fetch Contact Details`,
    shortLabel: msg`Fetch Contacts`,
    position: 11,
    Icon: IconPhone,
    accent: 'placeholder',
    isPinned: false,
    ...
    useAction: useFetchContactDetailsAction,
  },
  ...
  //     ActionViewType.INDEX_PAGE_SINGLE_RECORD_SELECTION,
  //   ],
  //   useAction: useCandidateAiFilteringAction,
  // },
