...
> = {
  ...
  restartMessages: {
    ...
    shortLabel: msg`Restart (remind) Messaging with Candidate`,
    label: msg`Restart (remind) Messaging with Candidate`,
    position: 9,
  ...
  resetMessagesFromWhatsapp: {
    ...
    shortLabel: msg`Delete and Restart (remind) Messaging in Whatsapp`,
    label: msg`Delete and Restart (remind) Messaging in Whatsapp`,
    position: 9,
    Icon: IconList,
    accent: 'placeholder',
    isPinned: false,
