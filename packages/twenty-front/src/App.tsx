        ...
        <Route element={<FullProviders />}>
          <Route element={<DefaultLayout />}>
            <Route path={AppPath.Verify} element={<VerifyEffect />} />
             ...
             <Route path={`${AppPath.VideoInterviewReview}/:candidateId`} element={<VideoInterviewResponseViewer candidateId={window.location.pathname}  videoInterviewId = {window.location.pathname} />} />
