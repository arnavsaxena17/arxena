        ...
        <>
          <Section>
            <H2Title
              ...
              description={t`Unlock enterprise features like SSO, advanced encryption, and custom AI models.`}
            />
            <Button
              Icon={IconKey}
              title={t`Get Enterprise Key`}
