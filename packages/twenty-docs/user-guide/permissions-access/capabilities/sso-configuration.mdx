...
Single Sign-On (SSO) allows your team members to log into Arxena using your organization's identity provider. This provides:
...
- Admin access to Arxena workspace

<Note>
**For self-hosting users willing to set up SSO**, reach out to contact@arxena.com
</Note>
...
- Remove them from the Arxena workspace
...
- **Group mapping**: Map IdP groups to Arxena roles (if available)
- **Offboarding process**: Include Arxena in your deprovisioning workflow
...
<Tip>
  Need SSO configured for your organization? [Find a certified Arxena partner](https://arxena.com/partners/list?categories=SOLUTIONING&ref=docs-sso) who specializes in SSO and identity setup. *(Prefer to loop in Arxena directly? [contact@arxena.com](mailto:contact@arxena.com).)*
</Tip>
