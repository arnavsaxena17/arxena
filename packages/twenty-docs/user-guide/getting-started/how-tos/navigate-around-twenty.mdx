...
The command menu gives you **quick access to actions** in Arxena. You can access it in two ways:
...
- Create new views
- Access deleted records (Arxena supports soft and hard deletes)
