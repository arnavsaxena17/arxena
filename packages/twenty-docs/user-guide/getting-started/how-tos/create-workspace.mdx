...
description: Follow a step-by-step guide on how to register on Arxena, choose a subscription plan, and set up your account.
---

import { VimeoEmbed } from '/snippets/vimeo-embed.mdx';

## Step 1: Registration
1. Navigate to [Arxena Sign Up](https://app.arxena.com).
...
## Support
For queries or help, connect with the dedicated support team at [contact@arxena.com](mailto:contact@arxena.com) or send a message on [Discord](https://discord.gg/cx5n4Jzs57).
