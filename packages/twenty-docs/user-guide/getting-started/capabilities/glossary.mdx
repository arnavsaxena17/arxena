---
title: Glossary
description: Get familiar with essential terminology used in Arxena.
---

## API
API (Application Programming Interface) allows you to connect Arxena with other software systems and build custom integrations.
...
## Opportunities
Opportunities in Arxena CRM are potential deals or sales with accounts or contacts.
...
## Tasks
Tasks in Arxena CRM are assigned activities relating to contacts, accounts, or opportunities.
...
## Webhooks
Webhooks are automated messages sent from Arxena to other applications when specific events occur, enabling real-time data synchronization.
...
## Workspace
A `Workspace` typically represents a company using Arxena. It holds all the records and data that you and your team members add to Arxena.
It has a single domain name, which is typically the domain name your company uses for employee email addresses.

## Workspace Members
Workspace Members are the Arxena users from your team who have access to your workspace. They can be assigned as owners or assignees for records.
