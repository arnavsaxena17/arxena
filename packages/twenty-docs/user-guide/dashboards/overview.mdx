---
title: Dashboards
description: Learn the basics of reporting and dashboards in Arxena.
---
...
Dashboards in Arxena provide a visual way to track your key performance metrics and gain insights from your CRM data.
...
<Note>
**Current limitations**:
- Exporting dashboards and sharing with external users (non-Arxena users) are not available at the moment.
