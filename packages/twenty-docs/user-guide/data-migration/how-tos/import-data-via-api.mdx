...
description: When and how to use Arxena's APIs for large-scale data imports.
---

## Overview

Arxena provides both **GraphQL** and **REST APIs** for programmatic data import. Use the API when CSV import isn't practical for your data volume or when you need automated, recurring imports.
...
Arxena enforces rate limits to ensure system stability:
...
- Verify formats match Arxena's requirements (see [Field Mapping](/user-guide/data-migration/capabilities/field-mapping))
...
- Verify data appears correctly in Arxena
...
Contact us at [contact@arxena.com](mailto:contact@arxena.com) or explore our [Implementation Services](/user-guide/getting-started/capabilities/implementation-services).
