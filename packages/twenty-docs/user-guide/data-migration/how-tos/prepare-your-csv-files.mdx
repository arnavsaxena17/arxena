...
description: Complete step-by-step guide to format your data for import into Arxena.
---
...
**This is the most important step.** The sample file shows you the exact column names and format Arxena expects.
...
Arxena enforces uniqueness on certain fields. Duplicates will cause import errors.
...
3. Check for duplicates that already exist in Arxena
...
- Must be unique (no duplicates in file or in Arxena)
...
- Must be unique within your file and in Arxena
...
### ID Fields
- **Optional**: Arxena auto-generates IDs if not provided
...
- The parent record must already exist in Arxena
...
## Step 6: Ensure Fields Exist in Arxena
