...
description: Step-by-step guide to migrate your Arxena self-hosted instance to Arxena Cloud.
---

## Overview

This guide walks you through migrating your data from an Arxena self-hosted instance to Arxena Cloud. The process involves setting up your cloud workspace, exporting your data, and re-importing it.
...
1. Go to [app.arxena.com](https://app.arxena.com) and create a new workspace
...
<Tip>
  Migrating a large or complex workspace? [Get a certified Arxena partner](https://arxena.com/partners/list?categories=HOSTING&ref=docs-migrate-cloud) to handle the move end-to-end. *(Or loop in our team: [contact@arxena.com](mailto:contact@arxena.com).)*
</Tip>
