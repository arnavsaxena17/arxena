...
Arxena comes with standard objects:
...
Every business works differently. Customizing your data model means you can shape Arxena around **your** processes instead of forcing yours into a rigid system.

Arxena offers full flexibility:
...
Identify the main concepts you work with. Arxena already provides:
...
<Tip>
  ...
  - **Done for you:** [find a certified Arxena partner](https://arxena.com/partners/list?categories=SOLUTIONING&ref=docs-data-model) to design and build your objects, fields, and relationships.
  - **Onboarding pack:** a 4-hour guided Data Model Design session with our team — [contact@arxena.com](mailto:contact@arxena.com). See [Implementation Services](/user-guide/getting-started/capabilities/implementation-services).
</Tip>
