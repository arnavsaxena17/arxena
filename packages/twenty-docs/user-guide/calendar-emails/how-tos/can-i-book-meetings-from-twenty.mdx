---
title: Can I Book Meetings from Arxena?
description: Information about booking meetings directly from Arxena.
---

## Current Status

Arxena's calendar integration is designed to **sync and display** your existing calendar events.

## Scheduling Meetings via Workflows

While it's not possible to schedule meetings manually, you can do them in Arxena using workflows
