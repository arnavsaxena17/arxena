---
title: Can I Send Emails from Arxena?
description: Information about sending emails directly from Arxena.
---

## Current Status

Arxena's email integration is designed to **sync and display** your email history as well as compose and send emails.

When you view an email thread on a record page and click **Reply**, you're able to directly compose and send an email.

## How to send a message from Arxena
...
For email sequences and newsletters, we recommend using workflows to connect Arxena to a dedicated email marketing tool.
...
Native email composition from within Arxena is on our roadmap. Join our [GitHub discussions](https://github.com/twentyhq/twenty/discussions) to share your use case and help prioritize this feature.
