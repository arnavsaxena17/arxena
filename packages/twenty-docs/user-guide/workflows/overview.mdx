---
title: Workflows
description: Learn how to build automations in Arxena.
---

## Why Workflows Matter

Arxena was built to bring maximum flexibility to its users. Rather than forcing you to adapt your business processes to rigid, pre-built features, workflows enable you to build automations that create the CRM that best supports your unique business use cases.

Workflows are Arxena's in-app feature for building these automations. They give you the building blocks to create exactly what your business needs, when it needs it.
...
2. **Bring data in and out of Arxena**: Connect Arxena via API calls and webhooks to your database and other tools.
...
- **Form**: Get inputs from users within Arxena UI at the time of execution
...
<Tip>
  ...
  - **Done for you:** [find a certified Arxena partner](https://arxena.com/partners/list?categories=SOLUTIONING&ref=docs-workflows) to design and build your automations end-to-end.
  - **Onboarding pack:** a 4-hour guided Workflow Creation session with our team — [contact@arxena.com](mailto:contact@arxena.com).
</Tip>
