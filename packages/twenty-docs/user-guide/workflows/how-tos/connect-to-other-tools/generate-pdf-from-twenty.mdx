---
title: Generate a PDF from Arxena
description: Create a workflow to generate and attach a PDF (such as a quote) to a record.
---

Automatically generate or fetch a PDF and attach it to a record in Arxena. This is commonly used to create quotes, invoices, or reports that are linked to Companies, Opportunities, or other objects.
...
2. Uploading the file to Arxena
...
- [Generate a Quote or Invoice from Arxena](/user-guide/workflows/how-tos/connect-to-other-tools/generate-quote-or-invoice-from-twenty)
