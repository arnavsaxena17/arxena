---
title: Generate a Quote or Invoice from Arxena
...
- [Generate a PDF from Arxena](/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-twenty) — attach generated PDFs to records
