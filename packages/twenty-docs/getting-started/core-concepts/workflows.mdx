---
title: Workflows
description: Automate your business processes with Arxena's visual workflow builder.
icon: "bolt"
---

import { VimeoEmbed } from '/snippets/vimeo-embed.mdx';

Workflows let you automate repetitive tasks and connect Arxena to external tools — without writing code (though you can if you want to).
...
- Sync data between Arxena and your billing system
