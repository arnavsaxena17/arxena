...
title: Apps
icon: "cube"
description: Extend Arxena with code — custom objects, server-side logic, UI components, and AI agents, all as TypeScript packages.
---


Most CRMs give you a config panel. Arxena gives you a platform. Apps are how developers extend Arxena beyond what the UI offers — defining data models, server-side logic, UI components, and AI capabilities as code, then deploying them to one or more workspaces.
...
| **Front Components** | Sandboxed React components that render inside Arxena's UI (side panel, widgets, command menu) |
