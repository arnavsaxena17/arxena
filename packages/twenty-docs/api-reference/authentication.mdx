...
[Taxonomy constants](/api-reference/taxonomy/list-taxonomy-constants) are Apollo-style flat label lists (grade levels, grade categories, function roots). Everything else that classifies, searches people, or builds Booleans requires Bearer auth.
