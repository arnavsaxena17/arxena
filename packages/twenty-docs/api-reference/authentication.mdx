...
description: Authenticate search API requests with a workspace-scoped Bearer token.
---
...
[Taxonomy constants](/api-reference/taxonomy/list-taxonomy-constants) are Apollo-style flat label lists (grade levels, grade categories, function roots). Search endpoints and other authenticated endpoints require Bearer auth.
