---
title: Self-Host
description: Deploy and manage Arxena on your own infrastructure.
---
<Frame>
...
Arxena can be self-hosted on your own infrastructure, giving you full control over your data and deployment.
