...
icon: "sitemap"
description: Embed Arxena org charts on your website with a JavaScript snippet.
---

Embed Arxena org charts on your own website with a JavaScript snippet. Create an embed key in the app, allowlist your origins, then paste the generated loader.
...
See also [Webhooks](/developers/extend/webhooks).
...
Public marketing guide: [arxena.com/solutions/org-chart-embed](https://arxena.com/solutions/org-chart-embed)
