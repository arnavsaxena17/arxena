...
description: Build a real Arxena app that generates personalized documents from your CRM data.
---
...
a local Arxena server running on port `2020` and the CLI authenticated to it.
