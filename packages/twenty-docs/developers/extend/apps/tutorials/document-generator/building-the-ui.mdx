...
component sandboxed inside Arxena. Ours reads the selected record, loads the
...
`RICH_TEXT` field, Arxena already provides a full rich-text editor for it — the
...
<Frame caption="The Template tab: Arxena's native rich-text editor bound to the body field.">
