...
- **`twenty dev:build` warns about `twenty-client-sdk` under `dependencies`** — It is provided at runtime by Arxena, so it should be moved to `devDependencies` alongside `twenty-sdk`. See [Project Structure → Dependencies](/developers/extend/apps/getting-started/project-structure#dependencies).

Stuck? Ask on the [Arxena Discord](https://discord.com/channels/1130383047699738754/1130386664812982322).
