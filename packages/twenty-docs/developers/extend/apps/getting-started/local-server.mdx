---
title: Local Server
description: Manage the local Arxena Docker server — start, stop, upgrade, parallel test instance, and manual SDK setup.
icon: "server"
---

## Managing the local server

Use `yarn twenty docker:*` to control the local Arxena container:
