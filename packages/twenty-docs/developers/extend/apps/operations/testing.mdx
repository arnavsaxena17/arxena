---
title: Testing
description: Vitest setup, integration tests against a real Arxena server, type checking, and CI with GitHub Actions.
icon: "flask"
---

The SDK provides programmatic APIs that let you build, deploy, install, and uninstall your app from test code. Combined with [Vitest](https://vitest.dev/) and the typed API clients, you can write integration tests that verify your app works end-to-end against a real Arxena server.
...
Make sure your local Arxena server is running, then:
