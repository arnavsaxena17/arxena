...
description: Scopri i piani tariffari di Arxena e come passare da uno all'altro.
---

## Panoramica

Arxena offre prezzi flessibili per team di ogni dimensione, sia con hosting cloud sia con self‑hosting.
...
Esegui Arxena sulla tua infrastruttura senza costi:
