---
title: Che cos'è Arxena
description: Arxena è un CRM open source che ti fornisce i componenti di base per creare esattamente ciò di cui la tua azienda ha bisogno.
---
...
All'inizio, Arxena appare come la maggior parte dei CRM che già conosci: puoi monitorare le trattative, organizzare i contatti, gestire compiti e note.
...
L'open-source è la base del nostro approccio, garantendo che Arxena evolva con la sua comunità, per la sua comunità.
...
[Registrati qui](https://app.arxena.com) o [diventa un collaboratore su GitHub](https://github.com/twentyhq/twenty).
