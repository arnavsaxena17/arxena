...
description: Segui una guida passo passo su come registrarti su Arxena, scegliere un piano di abbonamento e configurare il tuo account.
---
...
1. Vai a [Registrati su Arxena](https://app.arxena.com).
...
Per domande o aiuto, contatta il team di supporto dedicato a [contact@arxena.com](mailto:contact@arxena.com) o invia un messaggio su [Discord](https://discord.gg/cx5n4Jzs57).
