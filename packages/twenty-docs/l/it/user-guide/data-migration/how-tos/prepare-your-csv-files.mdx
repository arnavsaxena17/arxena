...
description: Guida completa passo passo per formattare i tuoi dati per l'importazione in Arxena.
---
...
**Questo è il passaggio più importante.** Il file di esempio ti mostra i nomi delle colonne e il formato esatti che Arxena si aspetta.
...
Arxena impone l'unicità su alcuni campi. I duplicati causeranno errori di importazione.
...
3. Verifica la presenza di duplicati già esistenti in Arxena
...
* Deve essere univoco (nessun duplicato nel file o in Arxena)
...
* Deve essere univoco all'interno del tuo file e in Arxena
...
* **Link / Etichetta del link**: `Arxena`
* **Link / URL del link**: `https://arxena.com`
...
* **Opzionale**: Arxena genera automaticamente gli ID se non forniti
...
* Il record padre deve già esistere in Arxena
...
## Passaggio 6: Verifica che i campi esistano in Arxena
