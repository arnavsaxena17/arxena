...
description: Guida passo-passo per migrare la tua istanza Arxena self-hosted verso Arxena Cloud.
---

## Panoramica

Questa guida ti accompagna nella migrazione dei tuoi dati da un'istanza Arxena self-hosted an Arxena Cloud. Il processo prevede la configurazione dello spazio di lavoro cloud, l'esportazione dei dati e la loro reimportazione.
...
1. Vai su [app.arxena.com](https://app.arxena.com) e crea un nuovo spazio di lavoro
...
<Tip>
  Stai eseguendo la migrazione di uno spazio di lavoro grande o complesso? [Trova un partner Arxena certificato](https://arxena.com/partners/list?categories=HOSTING\&ref=docs-migrate-cloud) per gestire l’intera migrazione end-to-end. *(Oppure coinvolgi il nostro team: [contact@arxena.com](mailto:contact@arxena.com).)*
</Tip>
