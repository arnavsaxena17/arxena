...
description: Scopri le azioni disponibili nei workflow di Arxena.
---
...
<Note>
Puoi inviare email solo dalle caselle di posta sincronizzate con il tuo account Arxena. L'invio dalle caselle di posta di altri membri del team (ad es., l'email del proprietario dell'account) è nella roadmap.
</Note>
...
In background, ogni azione Code è supportata dalla propria **logic function**, una funzione TypeScript lato server che viene eseguita sulla piattaforma Arxena. Quando aggiungi un'azione Code, Arxena crea una logic function dedicata per quel passaggio e ne espone l'editor inline, in modo che il codice che scrivi rimanga all'interno del flusso di lavoro.
