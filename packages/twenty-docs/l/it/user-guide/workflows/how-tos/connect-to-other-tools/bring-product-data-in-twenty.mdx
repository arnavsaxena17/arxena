---
title: Porta i dati di prodotto in Arxena
description: Sincronizza i dati del catalogo prodotti da un data warehouse nel tuo CRM in base a una pianificazione.
---

Usa questo modello per mantenere Arxena sincronizzato con i dati di prodotto dal tuo data warehouse (ad esempio, Snowflake, BigQuery, PostgreSQL).
...
5. **Upsert Record**: Crea o aggiorna in Arxena
