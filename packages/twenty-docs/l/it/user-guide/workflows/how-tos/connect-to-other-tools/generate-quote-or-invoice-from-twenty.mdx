---
title: Genera un preventivo o una fattura da Arxena
...
* [Generare un PDF da Arxena](/l/it/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-twenty) — allegare i PDF generati ai record
