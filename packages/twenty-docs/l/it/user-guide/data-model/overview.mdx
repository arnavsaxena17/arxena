...
Arxena include oggetti standard:
...
Ogni azienda lavora in modo diverso. Personalizzare il tuo modello di dati significa poter modellare Arxena attorno ai **tuoi** processi invece di forzarli dentro un sistema rigido.

Arxena offre massima flessibilità:
...
Identifica i concetti principali con cui lavori. Arxena offre già:
...
<Tip>
  ...
  * **Fatto per te:** [trova un partner Arxena certificato](https://arxena.com/partners/list?categories=SOLUTIONING\&ref=docs-data-model) per progettare e creare i tuoi oggetti, campi e relazioni.
  * **Pacchetto di onboarding:** una sessione guidata di 4 ore per la progettazione del modello di dati con il nostro team — [contact@arxena.com](mailto:contact@arxena.com). Vedi [Servizi di implementazione](/l/it/user-guide/getting-started/capabilities/implementation-services).
</Tip>
