...
description: Domande frequenti sulle impostazioni di Arxena.
---
...
Per modificare il tuo indirizzo email, contatta [contact@arxena.com](mailto:contact@arxena.com).
</Accordion>
...
* **Sottodominio**: usa un sottodominio di Arxena come `yourcompany.arxena.com`
