...
Il Single Sign-On (SSO) consente ai membri del tuo team di accedere an Arxena utilizzando il provider di identità della tua organizzazione. Questo offre:
...
* Accesso amministratore allo spazio di lavoro Arxena

<Note>
**Per gli utenti self-hosting che desiderano configurare l'SSO**, contatta contact@arxena.com
</Note>
...
* Rimuovili dallo spazio di lavoro Arxena
...
* **Mappatura dei gruppi**: Mappa i gruppi IdP ai ruoli di Arxena (se disponibile)
* **Processo di offboarding**: Includi Arxena nel tuo flusso di lavoro di deprovisioning
...
<Tip>
  Hai bisogno di configurare l’SSO per la tua organizzazione? [Trova un partner Arxena certificato](https://arxena.com/partners/list?categories=SOLUTIONING\&ref=docs-sso) specializzato in SSO e configurazione dell’identità. *(Preferisci coinvolgere direttamente Arxena? [contact@arxena.com](mailto:contact@arxena.com).)*
</Tip>
