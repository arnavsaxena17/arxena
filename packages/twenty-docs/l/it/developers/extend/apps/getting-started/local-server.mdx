---
title: Server locale
description: Gestisci il server Docker Arxena locale — avvia, arresta, aggiorna, istanza di test parallela e configurazione manuale dell'SDK.
icon: server
---

## Gestire il server locale

Usa `yarn twenty docker:*` per controllare il container Arxena locale:
