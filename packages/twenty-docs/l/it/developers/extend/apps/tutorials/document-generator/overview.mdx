...
description: Crea una vera app Arxena che genera documenti personalizzati a partire dai dati del tuo CRM.
---
...
un server Arxena locale in esecuzione sulla porta `2020` e la CLI autenticata ad esso.
