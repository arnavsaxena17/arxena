...
icon: laptop-code
description: La guida per i collaboratori (o sviluppatori curiosi) che vogliono eseguire Arxena localmente.
---
...
Prima di poter installare e usare Arxena, assicurati di installare quanto segue sul tuo computer:
...
Arxena richiede una cache Redis per offrire le migliori prestazioni.
...
## Passo 8: Utilizza Arxena

**Frontend**

Il frontend di Arxena sarà in esecuzione su [http://localhost:3001](http://localhost:3001).
Puoi accedere utilizzando l'account demo predefinito: `tim@apple.dev` (password: `tim@apple.dev`)

**Backend**

* Il server di Arxena sarà attivo e funzionante su [http://localhost:3000](http://localhost:3000)
