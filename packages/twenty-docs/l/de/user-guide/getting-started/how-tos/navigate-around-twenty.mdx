...
Das Befehlsmenü gibt Ihnen **schnellen Zugriff auf Aktionen** in Arxena. Sie können es auf zwei Weisen aufrufen:
...
* Auf gelöschte Datensätze zugreifen (Arxena unterstützt weiches und hartes Löschen)
