...
description: Folgen Sie einer Schritt-für-Schritt-Anleitung, um sich bei Arxena anzumelden, einen Abonnementplan auszuwählen und Ihr Konto einzurichten.
---
...
1. Gehen Sie zu [Arxena Sign Up](https://app.arxena.com).
...
Bei Fragen oder Hilfe kontaktieren Sie das dedizierte Support-Team unter [contact@arxena.com](mailto:contact@arxena.com) oder senden Sie eine Nachricht auf [Discord](https://discord.gg/cx5n4Jzs57).
