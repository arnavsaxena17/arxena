...
description: Schritt-für-Schritt-Anleitung zur Migration Ihrer selbstgehosteten Arxena-Instanz zu Arxena Cloud.
---

## Übersicht

Diese Anleitung führt Sie durch die Migration Ihrer Daten von einer selbstgehosteten Arxena-Instanz zu Arxena Cloud. Der Prozess umfasst das Einrichten Ihres Cloud-Arbeitsbereichs, das Exportieren Ihrer Daten und deren erneutes Importieren.
...
1. Gehen Sie zu [app.arxena.com](https://app.arxena.com) und erstellen Sie einen neuen Arbeitsbereich
...
<Tip>
  Migrieren Sie einen großen oder komplexen Workspace? [Holen Sie sich einen zertifizierten Arxena-Partner](https://arxena.com/partners/list?categories=HOSTING\&ref=docs-migrate-cloud), der den Umzug Ende-zu-Ende übernimmt. *(Oder binden Sie unser Team ein: [contact@arxena.com](mailto:contact@arxena.com).)*
</Tip>
