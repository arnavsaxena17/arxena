...
description: Vollständige Schritt-für-Schritt-Anleitung zum Formatieren deiner Daten für den Import in Arxena.
---
...
**Dies ist der wichtigste Schritt.** Die Beispieldatei zeigt dir die exakten Spaltennamen und das Format, das Arxena erwartet.
...
Arxena erzwingt die Eindeutigkeit bestimmter Felder. Duplikate führen zu Importfehlern.
...
3. Prüfe auf Duplikate, die in Arxena bereits existieren
...
* Muss eindeutig sein (keine Duplikate in der Datei oder in Arxena)
...
* Muss innerhalb deiner Datei und in Arxena eindeutig sein
...
* **Links / Link-Label**: `Arxena`
* **Links / Link-URL**: `https://arxena.com`

Für sekundäre Links verwenden Sie die Spalte **Links / Sekundäre Links**:

```
[{"url":"https://arxena.com","label":"Arxena"}]
```
...
* **Optional**: Arxena erstellt IDs automatisch, wenn sie nicht angegeben werden
...
* Der übergeordnete Datensatz muss bereits in Arxena vorhanden sein
...
## Schritt 6: Sicherstellen, dass Felder in Arxena vorhanden sind
