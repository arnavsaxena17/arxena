...
description: Wann und wie Sie die APIs von Arxena für groß angelegte Datenimporte verwenden.
---

## Übersicht

Arxena stellt sowohl **GraphQL**- als auch **REST-APIs** für den programmatischen Datenimport bereit. Verwenden Sie die API, wenn der CSV-Import für Ihr Datenvolumen nicht praktikabel ist oder wenn Sie automatisierte, wiederkehrende Importe benötigen.
...
Arxena setzt Rate-Limits durch, um die Systemstabilität zu gewährleisten:
...
Arxena unterstützt zwei API-Typen:
...
* Überprüfen Sie, ob die Formate den Anforderungen von Arxena entsprechen (siehe [Feldzuordnung](/l/de/user-guide/data-migration/capabilities/field-mapping))
...
* Überprüfen Sie, ob die Daten in Arxena korrekt angezeigt werden
...
Kontaktieren Sie uns unter [contact@arxena.com](mailto:contact@arxena.com) oder informieren Sie sich über unsere [Implementierungsservices](/l/de/user-guide/getting-started/capabilities/implementation-services).
