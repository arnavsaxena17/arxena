---
title: Produktdaten in Arxena importieren
description: Synchronisieren Sie Produktkatalogdaten nach Zeitplan aus einem Data Warehouse in Ihr CRM.
---

Verwenden Sie dieses Muster, um Arxena mit Produktdaten aus Ihrem Data Warehouse (z. B. Snowflake, BigQuery, PostgreSQL) synchron zu halten.
...
5. **Upsert Record**: In Arxena erstellen oder aktualisieren
