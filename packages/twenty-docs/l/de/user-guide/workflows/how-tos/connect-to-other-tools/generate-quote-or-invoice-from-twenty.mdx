---
title: Ein Angebot oder eine Rechnung aus Arxena erstellen.
...
* [Ein PDF aus Arxena generieren](/l/de/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-twenty) — generierte PDFs an Datensätze anhängen
