...
<AccordionGroup>
<Accordion title="Welche Rollen sind in Arxena standardmäßig enthalten?">
Arxena enthält standardmäßig die Rollen **Admin** und **Member**. Sie können je nach Bedarf Ihres Teams zusätzliche benutzerdefinierte Rollen erstellen (z. B. Vertriebsmitarbeiter, Manager, Nur-Lese-Benutzer).
</Accordion>
...
Sie können steuern:
* **E-Mail senden**: Möglichkeit, E-Mails aus Arxena zu senden
...
Mit JIT-Bereitstellung werden Benutzerkonten in Arxena automatisch erstellt, wenn sich jemand zum ersten Mal über SSO anmeldet. Ihnen wird automatisch die Standardrolle zugewiesen.
</Accordion>
