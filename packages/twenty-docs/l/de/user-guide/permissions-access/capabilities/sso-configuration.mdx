...
Single Sign-On (SSO) ermöglicht es Ihren Teammitgliedern, sich mit dem Identitätsanbieter Ihrer Organisation bei Arxena anzumelden. Dies bietet:
...
* Administratorzugriff auf den Arxena-Arbeitsbereich

<Note>
**Für Self-Hosting-Nutzer, die SSO einrichten möchten**, wenden Sie sich an contact@arxena.com
</Note>
...
* Entfernen Sie sie aus dem Arxena-Arbeitsbereich
...
* **Gruppenzuordnung**: Ordnen Sie IdP-Gruppen Arxena-Rollen zu (falls verfügbar)
* **Offboarding-Prozess**: Beziehen Sie Arxena in Ihren Deprovisioning-Workflow ein
...
<Tip>
  Benötigen Sie eine SSO-Konfiguration für Ihre Organisation? [Finden Sie einen zertifizierten Arxena-Partner](https://arxena.com/partners/list?categories=SOLUTIONING\&ref=docs-sso), der auf SSO und Identitätseinrichtung spezialisiert ist. *(Sie möchten Arxena lieber direkt einbeziehen? [contact@arxena.com](mailto:contact@arxena.com).)*
</Tip>
