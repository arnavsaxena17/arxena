...
Webhooks übermitteln Daten in Echtzeit an Ihre Systeme, wenn Ereignisse in Arxena auftreten — kein Polling erforderlich. Verwenden Sie sie, um externe Systeme synchron zu halten, Automatisierungen auszulösen oder Benachrichtigungen zu senden.
...
Arxena sendet Webhooks für diese Ereignistypen:
...
Arxena signiert jede Webhook-Anfrage zu Sicherheitszwecken. Validieren Sie die Signaturen, um sicherzustellen, dass die Anfragen authentisch sind.
...
| **Workflow-Webhook-Trigger** | IN       | Daten aus externen Systemen in Arxena empfangen                                  |
