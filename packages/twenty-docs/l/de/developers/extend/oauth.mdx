...
Arxena implementiert OAuth 2.0 mit Autorisierungscode + PKCE für benutzerorientierte Apps und Client-Anmeldedaten für Server-zu-Server-Zugriff. Clients werden dynamisch über [RFC 7591](https://datatracker.ietf.org/doc/html/rfc7591) registriert — keine manuelle Einrichtung in einem Dashboard.
...
| Arxena-App mit UI-Erweiterungen                   | [Apps](/l/de/developers/extend/apps/getting-started) (OAuth wird automatisch gehandhabt) |

## Einen Client registrieren

Arxena unterstützt die **dynamische Client-Registrierung** gemäß [RFC 7591](https://datatracker.ietf.org/doc/html/rfc7591). Keine manuelle Einrichtung erforderlich — registrieren Sie den Client programmgesteuert:
...
Verwenden Sie diesen Flow, wenn Ihre App im Namen eines Arxena-Benutzers handelt.
...
Nach der Autorisierung leitet Arxena zurück zu Ihrer `redirect_uri` weiter:
...
Arxena veröffentlicht seine OAuth-Konfiguration an einem standardisierten Discovery-Endpunkt:
