...
description: Erstellen Sie eine echte Arxena-App, die personalisierte Dokumente aus Ihren CRM-Daten generiert.
---
...
einen lokalen Arxena-Server, der auf Port `2020` läuft, und die CLI, die damit authentifiziert ist.
