...
und selbstgehosteten Instanzen wird dieser Pfad von Ihrem Arxena-Server
bereitgestellt (z. B. `http://localhost:2020/s/documents/generate`). In Arxena Cloud löst `RestApiClient` den Pfad über die Funktionen-Domain des Workspaces auf.
