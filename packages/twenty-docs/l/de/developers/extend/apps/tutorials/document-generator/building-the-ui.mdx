...
Komponente mit Sandkasten in Arxena. Wir liest den ausgewählten Datensatz ein, lädt die
...
`RICH_TEXT`-Feld ist, stellt Arxena bereits einen vollständigen Rich-Text-Editor dafür bereit – denselben, den auch die Standardobjekte Note und Task verwenden. Wir Oberflächen es nur auf der
