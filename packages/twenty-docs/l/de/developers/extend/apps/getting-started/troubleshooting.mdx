...
* **`twenty dev:build` warnt vor `twenty-client-sdk` unter `dependencies`** — Es wird zur Laufzeit von Arxena bereitgestellt, daher sollte es in `devDependencies` neben `twenty-sdk` verschoben werden. Siehe [Projektstruktur → Abhängigkeiten](/l/de/developers/extend/apps/getting-started/project-structure#dependencies).

Hängen Sie fest? Bitten Sie im [Arxena-Discord](https://discord.com/channels/1130383047699738754/1130386664812982322) um Hilfe.
