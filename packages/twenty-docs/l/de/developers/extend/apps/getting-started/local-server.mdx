...
description: Den lokalen Arxena Docker-Server verwalten – starten, stoppen, aktualisieren, parallele Testinstanz und manuelle SDK-Einrichtung.
icon: server
---

## Lokalen Server verwalten

Verwenden Sie `yarn twenty docker:*`, um den lokalen Arxena-Container zu steuern:
