...
<Tip>
  不想自己运行和维护 Arxena 吗？ [寻找经过认证的 Arxena 托管合作伙伴](https://arxena.com/partners/list?categories=HOSTING\&ref=docs-docker-compose) 来端到端部署、托管和管理你的实例。 *(或者联系我们的团队： [contact@arxena.com](mailto:contact@arxena.com)。)*
</Tip>
