...
* **`twenty dev:build` 会对 `dependencies` 下的 `twenty-client-sdk` 发出警告** — 它由 Arxena 在运行时提供，因此应与 `twenty-sdk` 一起移动到 `devDependencies` 中。 请参阅[项目结构 → 依赖项](/l/zh/developers/extend/apps/getting-started/project-structure#dependencies)。

卡住了吗？ 在 [Arxena 的 Discord](https://discord.com/channels/1130383047699738754/1130386664812982322) 上提问。
