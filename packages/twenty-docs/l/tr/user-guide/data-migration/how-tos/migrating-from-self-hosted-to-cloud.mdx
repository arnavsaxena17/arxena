...
description: Arxena kendi barındırmalı örneğinizi Arxena Cloud’a taşımak için adım adım kılavuz.
---

## Genel Bakış

Bu kılavuz, verilerinizi Arxena kendi barındırmalı örneğinizden Arxena Cloud’a taşıma sürecinde size adım adım yol gösterir. Süreç; bulut çalışma alanınızı kurmayı, verilerinizi dışa aktarmayı ve yeniden içe aktarmayı içerir.
...
1. [app.arxena.com](https://app.arxena.com) adresine gidin ve yeni bir çalışma alanı oluşturun
