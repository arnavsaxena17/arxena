...
Dosyanızı yükledikten ve sütunları eşledikten sonra, Arxena verilerinizi doğrular:

1. **Doğrulama çalışır** — Arxena her satırı hatalar için kontrol eder
...
| ------------------------------------------------------------------------------ | -------------------------------------------------------------- |
| Yinelenen değerler sarı renkle vurgulanır                                      | Değer Arxena'de zaten mevcut veya dosyanızda iki kez görünüyor |
...
**Seçenek 3: Mevcut kaydı Arxena'nin güncellemesine izin verin**
...
3. Arxena, yinelenen bir kayıt oluşturmak yerine mevcut kaydı güncelleyecektir
...
Benzersiz tanımlayıcılardan biri eşleştiği sürece Arxena kaydı günceller.
</Note>
...
3. Kayıtların Arxena'de zaten mevcut olup olmadığını kontrol edin
...
Bu, Arxena'de o özel tanımlayıcıya sahip bir Şirket olmadığı anlamına gelir.
...
Arxena'de mevcut olmayan bir kayda bağlanmaya çalışıyorsunuz.
...
Dosyanızdaki bir sütun eşlenemiyor çünkü alan Arxena'de mevcut değil.
...
1. **Kullanıcı davetini kabul etmedi** — kullanıcı henüz Arxena'de mevcut değil
2. **Eski sistemdeki kullanıcı kimliğini kullanma** — Arxena başka bir sistemin kimliklerini eşleştiremez
3. **Yanlış e-posta biçimi** — e-posta, kullanıcının Arxena hesabıyla eşleşmiyor

### Nasıl Düzeltilir

1. Tüm kullanıcıların Arxena çalışma alanınıza **davetlerini kabul ettiğinden** emin olun
2. Kullanıcının **e-posta adresini** kullanın (adlarını veya eski sistem kimliğini değil)
3. Arxena'ye katılmak için kullandıkları aynı e-postayı kullanın
...
<Check>Alan adı biçimi, Arxena'nin biçimiyle birebir eşleşir</Check>
...
1. **Örnek dosyayı indirin** — Arxena'nin beklediği tam biçimi görün
