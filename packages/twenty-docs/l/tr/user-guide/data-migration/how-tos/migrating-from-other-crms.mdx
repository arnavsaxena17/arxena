...
description: Verilerinizi herhangi bir CRM'den Arxena'ye taşımak için adım adım kılavuz.
---

## Genel Bakış

Bu kılavuz, verilerinizi herhangi bir CRM'den Arxena'ye taşıma sürecinde size yol gösterir. Süreç, verilerinizi denetlemeyi, Arxena çalışma alanınızı hazırlamayı, mevcut sisteminizden dışa aktarmayı ve Arxena'ye içe aktarmayı içerir.
...
Mevcut CRM'iniz ile Arxena arasında bir eşleme belgesi oluşturun:
...
## Adım 3: Arxena Çalışma Alanınızı Kurun

Verileri içe aktarmadan önce Arxena çalışma alanınızı hazırlayın:
...
Verileriniz kullanıcı referansları içeriyorsa (Hesap Sahibi, Atanan vb.), bu kullanıcıların içe aktarmadan önce Arxena'de mevcut olması gerekir. Aksi halde bu ilişkiler eşlenemez.
</Warning>
...
Dışa aktarılan her CSV'yi bir hesap tablosu uygulamasında açın ve Arxena için hazırlayın.
...
3. Arxena'de halihazırda yinelenen olmadığını doğrulayın
...
`https://domain.com` kullanın (`domain.com` veya `www.domain.com` değil). Bu, Arxena'nin biçimiyle eşleşir ve e-posta/takvim eşzamanlamasını bağladığınızda yinelenmeleri önler.
</Warning>
...
2. Kullanıcıların Arxena çalışma alanınıza katılmak için kullandıklarıyla aynı e-posta adreslerini kullanın
...
* Arxena, e-postaları kişi kayıtlarıyla eşzamanlamaya başlayacaktır
...
<AccordionGroup>
  <Accordion title="İş akışlarını otomatik olarak taşıyabilir miyim?">
    Şu anda mümkün değil. İş akışları Arxena'de manuel olarak yeniden oluşturulmalıdır.
  </Accordion>
...
<Tip>
  ...
  * **Sizin yerinize yapılır:** verilerinizi, pipeline'larınızı ve kullanıcılarınızı uçtan uca taşımak için [sertifikalı bir Arxena iş ortağı bulun](https://arxena.com/partners/list?categories=SOLUTIONING\&ref=docs-migrate-crm).
  * **Oryantasyon paketi:** ekibimizle 4 saatlik rehberli kurulum — [contact@arxena.com](mailto:contact@arxena.com).
</Tip>
