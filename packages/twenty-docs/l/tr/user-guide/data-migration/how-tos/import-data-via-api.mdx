...
description: Büyük ölçekli veri içe aktarmaları için Arxena'nin API'lerini ne zaman ve nasıl kullanacağınız.
---

## Genel Bakış

Arxena, programatik veri içe aktarma için hem **GraphQL** hem de **REST API'leri** sunar. Veri hacminiz için CSV içe aktarma pratik değilse veya otomatik, yinelenen içe aktarmalara ihtiyacınız varsa API'yi kullanın.
...
Arxena, sistem kararlılığını sağlamak için hız sınırlarını uygular:
...
Arxena iki API türünü destekler:
...
* Biçimlerin Arxena'nin gereksinimlerine uyduğunu doğrulayın (bkz. [Alan Eşleme](/l/tr/user-guide/data-migration/capabilities/field-mapping))
...
* Verilerin Arxena'de doğru göründüğünü doğrulayın
...
[contact@arxena.com](mailto:contact@arxena.com) adresinden bizimle iletişime geçin veya [Uygulama Hizmetlerimizi](/l/tr/user-guide/getting-started/capabilities/implementation-services) keşfedin.
