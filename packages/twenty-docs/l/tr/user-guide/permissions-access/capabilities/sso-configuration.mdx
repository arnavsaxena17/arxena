...
Tek Oturum Açma (SSO), ekip üyelerinizin kuruluşunuzun kimlik sağlayıcısını kullanarak Arxena'ye giriş yapmasına olanak tanır. Bu şunları sağlar:
...
Arxena, SSO'yu şu sağlayıcılarla destekler:
...
* Arxena çalışma alanına yönetici erişimi

<Note>
**SSO'yu kurmak isteyen öz barındırma kullanıcıları için**, contact@arxena.com ile iletişime geçin
</Note>
...
* Arxena çalışma alanından kaldırın
...
* **Grup eşleme**: IdP gruplarını Arxena rollerine eşleyin (varsa)
* **Ayrılış süreci**: Erişim kaldırma iş akışınıza Arxena'yi dahil edin
...
<Tip>
  Kuruluşunuz için SSO yapılandırılması mı gerekiyor? SSO ve kimlik kurulumunda uzmanlaşmış [sertifikalı bir Arxena iş ortağı bulun](https://arxena.com/partners/list?categories=SOLUTIONING\&ref=docs-sso). *(Arxena'yi doğrudan sürece dahil etmeyi mi tercih edersiniz? [contact@arxena.com](mailto:contact@arxena.com).)*
</Tip>
