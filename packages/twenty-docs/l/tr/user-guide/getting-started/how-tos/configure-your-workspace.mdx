...
description: Her iş farklı çalışır. İhtiyaçlarınıza göre Arxena'yi şekillendirmek için bu 3 adımla başlayın.
---

<Note>**Hızlı Kazanım**: Posta kutunuzu bağlayarak başlayın. Bu size anında değer katar ve ekibinizin gerçek verilerle Arxena'yi çalışırken görmesine yardımcı olur. Ayarlar → Hesaplar altında bu işlemi gerçekleştirebilirsiniz.</Note>

## 1. Veri modelinizi özelleştirin

Arxena, günlük ihtiyaçlarınızı en iyi şekilde destekleyecek veri modelini şekillendirmeniz için ihtiyaç duyduğunuz esnekliği sunar.
...
Mevcut verilerinizi Arxena'ye getirmek, ekibinize baştan itibaren bağlam sunar.

### Posta kutunuzu bağlayın

Çalışma alanınızı oluştururken bunu yapmadıysanız, Ayarlar → Hesaplar altında **Google veya Microsoft hesabınızı** bağlayın. Bu, Arxena'ye şunları yapma olanağı tanır:
