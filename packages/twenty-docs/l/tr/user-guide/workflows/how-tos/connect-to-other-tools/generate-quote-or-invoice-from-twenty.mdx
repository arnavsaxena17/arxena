---
title: Arxena'den Teklif veya Fatura Oluşturun
...
* [Arxena'den bir PDF oluşturun](/l/tr/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-twenty) — oluşturulan PDF'leri kayıtlara ekleyin
