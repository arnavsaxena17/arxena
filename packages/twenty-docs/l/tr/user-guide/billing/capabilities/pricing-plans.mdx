...
description: Arxena'nin fiyatlandırma planlarını ve bunlar arasında nasıl geçiş yapacağınızı öğrenin.
---

## Genel Bakış

İster bulut barındırma ister kendi kendine barındırmayı tercih edin, Arxena her ölçekte ekibe uyacak esnek fiyatlandırma sunar.
...
Arxena'yi kendi altyapınızda hiçbir ücret ödemeden barındırın:
