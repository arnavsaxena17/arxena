...
description: Arxena'nin açık kaynak geliştirmesine katkıda bulunun.
---
...
Arxena açık kaynaktır ve topluluktan gelen katkıları memnuniyetle karşılar. İster hataları düzeltiyor, ister özellikler ekliyor ya da belgeleri iyileştiriyor olun, katkılarınız Arxena'yi herkes için daha iyi hâle getirmeye yardımcı olur.
