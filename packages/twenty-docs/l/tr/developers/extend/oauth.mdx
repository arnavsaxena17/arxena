...
| UI uzantılarına sahip Arxena Uygulaması             | [Uygulamalar](/l/tr/developers/extend/apps/getting-started) (OAuth otomatik olarak yönetilir) |

## Bir İstemci Kaydedin

Arxena, [RFC 7591](https://datatracker.ietf.org/doc/html/rfc7591) uyarınca **dinamik istemci kaydını** destekler. Manuel kurulum gerekmez — programatik olarak kaydedin:
...
Uygulamanız bir Arxena kullanıcısı adına hareket ettiğinde bu akışı kullanın.
...
Yetkilendirmeden sonra, Arxena `redirect_uri` adresinize geri yönlendirir:
...
Arxena, OAuth yapılandırmasını standart bir keşif uç noktasında yayımlar:
