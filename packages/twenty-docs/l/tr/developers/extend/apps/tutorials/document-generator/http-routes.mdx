...
ve kendi sunucunuzda barındırılan örneklerde, bu yol Arxena sunucunuz
tarafından sunulur (örneğin `http://localhost:2020/s/documents/generate`). Arxena Cloud'da, `RestApiClient`
