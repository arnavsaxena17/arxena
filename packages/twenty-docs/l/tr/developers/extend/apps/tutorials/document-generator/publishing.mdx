...
export default defineApplication({
  ...
  websiteUrl: 'https://docs.arxena.com/l/tr/developers/extend/apps',
  termsUrl: 'https://www.arxena.com/terms',
  emailSupport: 'contact@arxena.com',
...
`app:publish` varsayılan olarak oluşturur ve npm'e yayımlar; `--private` bunun yerine bir tarball dosyasını bir Arxena sunucusunun özel kaydına yükler. Yayımlanmış bir uygulamayı bir örneğin pazaryerinde görünür kılmak için, bir katalog eşitlemesini tetikleyin:
