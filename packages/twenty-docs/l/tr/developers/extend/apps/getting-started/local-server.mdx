---
title: Yerel Sunucu
description: Yerel Arxena Docker sunucusunu yönetin — başlatın, durdurun, yükseltin, paralel test örneği çalıştırın ve manuel SDK kurulumu yapın.
icon: server
---

## Yerel sunucuyu yönetme

Yerel Arxena konteynerini kontrol etmek için `yarn twenty docker:*` kullanın:
