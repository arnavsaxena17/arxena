...
* Alışıldık mantık işlevi ortamı (`APPLICATION_ID`, `APP_ACCESS_TOKEN`, `API_URL`) enjekte edilir, böylece Arxena API'sini uygulamanızın jetonuyla çağırabilirsiniz.
