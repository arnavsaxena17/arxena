...
description: Porozumění funkcím e-mailové integrace v Arxena.
---
...
Arxena automaticky propojuje emaily z vašich připojených schránek s příslušnými CRM záznamy, udržuje historii komunikace na jednom místě.
...
Arxena importuje e-maily rychlostí přibližně **400 zpráv za minutu**. Tato rychlost je v současnosti omezena omezením rychlosti Gmail API (a podobně to platí i pro další poskytovatele).
...
Zvolte, zda se mají interní e-maily v Arxena synchronizovat:
...
* **Chybějící emaily**: Zkontrolujte, zda:
  ...
  * Automatické vytváření kontaktů je deaktivováno (emaily potřebují existující záznamy Arxena)
