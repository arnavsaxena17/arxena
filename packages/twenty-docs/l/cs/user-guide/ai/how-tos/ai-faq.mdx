...
description: Často kladené otázky k funkcím AI v Arxena.
---
...
<AccordionGroup>
  ...
  <Accordion title="Jaké možnosti AI jsou k dispozici?">
    ...
    1. **AI Chatbot**: Asistent s kontextovým povědomím, který může přistupovat k vašim datům v Arxena a pomůže vám s dotazy
  ...
  <Accordion title="Mohu používat vlastní modely AI?">
    V cloudu můžete používat pouze modely AI poskytované Arxena. Ve své self‑hostované instanci můžete po získání licence Organization používat vlastní modely AI.
  </Accordion>
