...
Po nahrání souboru a namapování sloupců Arxena vaše data ověří:

1. **Proběhne validace** — Arxena zkontroluje každý řádek na chyby
...
| --------------------------------------------------------------------- | ------------------------------------------------------------------------ |
| Duplicitní hodnoty zvýrazněné žlutě                                   | Hodnota již existuje v Arxena nebo se ve vašem souboru vyskytuje dvakrát |
...
**Možnost 3: Nechte Arxena aktualizovat existující záznam**
...
3. Arxena aktualizuje existující záznam místo vytvoření duplicity
...
Pokud se shoduje alespoň jeden jedinečný identifikátor, Arxena záznam aktualizuje.
</Note>
...
3. Zkontrolujte, zda záznamy v Arxena již existují
...
To znamená, že v Arxena neexistuje společnost s tímto konkrétním identifikátorem.
...
Pokoušíte se propojit se záznamem, který v Arxena neexistuje.
...
Sloupec ve vašem souboru nelze namapovat, protože pole v Arxena neexistuje.
...
1. **Uživatel nepřijal pozvánku** — uživatel zatím v Arxena neexistuje
2. **Používáte uživatelské ID ze starého systému** — Arxena nedokáže spárovat ID z jiného systému
3. **Nesprávný formát e-mailu** — e-mail neodpovídá účtu uživatele v Arxena

### Jak to opravit

1. Ujistěte se, že všichni uživatelé **přijali svou pozvánku** do vašeho pracovního prostoru Arxena
2. Použijte **e-mailovou adresu** uživatele (ne jeho jméno nebo ID ze starého systému)
3. Použijte stejný e-mail, jaký použili k připojení do Arxena
...
<Check>Formát domény přesně odpovídá formátu Arxena</Check>
...
1. **Stáhněte si ukázkový soubor** — uvidíte přesný formát, který Arxena očekává
