...
description: Podrobný průvodce krok za krokem pro migraci vašich dat z libovolného CRM do Arxena.
---

## Přehled

Tento průvodce vás provede migrací vašich dat z libovolného CRM do Arxena. Proces zahrnuje audit vašich dat, přípravu vašeho pracovního prostoru Arxena, export z vašeho současného systému a import do Arxena.
...
Vytvořte mapovací dokument mezi vaším současným CRM an Arxena:
...
## Krok 3: Nastavte svůj pracovní prostor Arxena

Před importem dat připravte svůj pracovní prostor Arxena:
...
Pokud vaše data obsahují odkazy na uživatele (vlastník účtu, přiřazený uživatel apod.), tito uživatelé musí v Arxena existovat před importem. Jinak tyto relace nelze namapovat.
</Warning>
...
Otevřete každý exportovaný soubor CSV v tabulkovém editoru a připravte jej pro Arxena.

### Odstraňte duplicity

1. Seřaďte podle jedinečného pole (e-mail u lidí, doména u společností)
2. Odstraňte nebo sloučte duplicitní řádky
3. Ověřte, že v Arxena již neexistují žádné duplicity
...
Použijte `https://domain.com` (ne `domain.com` ani `www.domain.com`). To odpovídá formátu Arxena a předchází duplicitám, když připojíte synchronizaci e-mailu/kalendáře.
</Warning>
...
2. Použijte stejné e-mailové adresy, které uživatelé použili při připojení do vašeho pracovního prostoru Arxena
...
* Arxena začne synchronizovat e-maily k záznamům kontaktů
...
<AccordionGroup>
  <Accordion title="Mohu migrovat pracovní postupy automaticky?">
    V tuto chvíli ne. Pracovní postupy je nutné v Arxena znovu vytvořit ručně.
  </Accordion>
...
<Tip>
  ...
  * **Hotovo za vás:** [najděte certifikovaného partnera Arxena](https://arxena.com/partners/list?categories=SOLUTIONING\&ref=docs-migrate-crm), který zajistí kompletní přesun vašich dat, pipeline a uživatelů od začátku do konce.
  * **Onboardingový balíček:** čtyřhodinové asistované nastavení s naším týmem — [contact@arxena.com](mailto:contact@arxena.com).
</Tip>
