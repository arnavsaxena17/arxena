...
description: Kompletní návod krok za krokem, jak naformátovat data pro import do Arxena.
---
...
**Toto je nejdůležitější krok.** Ukázkový soubor ukazuje přesné názvy sloupců a formát, který Arxena očekává.
...
Arxena vynucuje jedinečnost u některých polí. Duplicity způsobí chyby při importu.
...
3. Zkontrolujte duplicity, které už v Arxena existují
...
* Musí být jedinečné (žádné duplicity v souboru ani v Arxena)
...
* Musí být jedinečné v rámci vašeho souboru i v Arxena
...
* **Odkazy / Štítek odkazu**: `Arxena`
* **Odkazy / URL odkazu**: `https://arxena.com`
...
* **Volitelné**: Arxena automaticky generuje ID, pokud nejsou zadána
...
* Nadřazený záznam musí v Arxena již existovat
...
## Krok 6: Ujistěte se, že pole v Arxena existují
