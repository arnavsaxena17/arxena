...
description: Podrobný průvodce krok za krokem pro migraci vaší instance Arxena hostované na vlastním serveru do Arxena Cloud.
---

## Přehled

Tento průvodce vás provede migrací vašich dat z instance Arxena hostované na vlastním serveru do Arxena Cloud. Proces zahrnuje zřízení vašeho cloudového pracovního prostoru, export dat a jejich opětovný import.
...
1. Přejděte na [app.arxena.com](https://app.arxena.com) a vytvořte nový pracovní prostor
...
<Tip>
  Migrujete velký nebo složitý pracovní prostor? [Najměte si certifikovaného partnera Arxena](https://arxena.com/partners/list?categories=HOSTING\&ref=docs-migrate-cloud), který za vás zajistí kompletní přesun od začátku do konce. *(Nebo do komunikace zapojte náš tým: [contact@arxena.com](mailto:contact@arxena.com).)*
</Tip>
