---
title: Rozvržení
description: Přizpůsobte si, jak v Arxena navigujete, procházíte a zobrazujete záznamy.
---

Rozvržení Arxena je přizpůsobitelné na třech úrovních: jak v aplikaci navigujete, jak procházíte seznamy záznamů a co vidíte při otevření jednotlivého záznamu.
...
Zobrazení určují, jak se zobrazují seznamy záznamů. Arxena podporuje tři typy zobrazení:
