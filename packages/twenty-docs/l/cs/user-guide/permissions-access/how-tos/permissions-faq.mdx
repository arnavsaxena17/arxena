...
<AccordionGroup>
<Accordion title="Jaké role jsou ve Arxena ve výchozím nastavení?">
Arxena ve výchozím stavu obsahuje role **Administrátor** a **Člen**. Můžete vytvářet další vlastní role podle potřeb vašeho týmu (např. obchodní zástupce, manažer, uživatel pouze pro čtení).
</Accordion>
...
Můžete řídit:
* **Odeslat e-mail**: Možnost odesílat e-maily z Arxena
...
Při zřizování JIT se uživatelské účty v Arxena vytvoří automaticky, když se někdo poprvé přihlásí přes SSO. Automaticky jim je přiřazena výchozí role.
</Accordion>
