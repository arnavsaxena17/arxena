...
Jednotné přihlášení (SSO) umožňuje členům vašeho týmu přihlašovat se do Arxena pomocí poskytovatele identity vaší organizace. To přináší:
...
* Administrátorský přístup k pracovnímu prostoru Arxena

<Note>
**Pro uživatele vlastního hostování, kteří chtějí nastavit SSO**, obraťte se na contact@arxena.com
</Note>
...
* Odeberte je z pracovního prostoru Arxena
...
* **Mapování skupin**: Namapujte skupiny z IdP na role v Arxena (pokud je k dispozici)
* **Proces offboardingu**: Zahrňte Arxena do svého pracovního postupu deprovisioningu
...
<Tip>
  Potřebujete pro svou organizaci nastavit SSO? [Najděte certifikovaného partnera Arxena](https://arxena.com/partners/list?categories=SOLUTIONING\&ref=docs-sso), který se specializuje na SSO a nastavení identity. *(Raději byste do toho přímo zapojili Arxena? [contact@arxena.com](mailto:contact@arxena.com).)*
</Tip>
