...
description: Sledujte podrobný návod, jak se zaregistrovat na Arxena, vybrat si plán předplatného a nastavit svůj účet.
---
...
1. Přejděte na [Registrace Arxena](https://app.arxena.com).
...
V případě dotazů nebo potřeby pomoci kontaktujte specializovaný tým podpory na [contact@arxena.com](mailto:contact@arxena.com) nebo pošlete zprávu na [Discord](https://discord.gg/cx5n4Jzs57).
