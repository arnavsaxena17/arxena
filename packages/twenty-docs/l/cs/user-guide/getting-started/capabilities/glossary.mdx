---
title: Glosář
description: Seznamte se se základní terminologií používanou v aplikaci Arxena.
---

## API

API (rozhraní pro programování aplikací) umožňuje propojení Arxena s dalšími softwarovými systémy a vytváření vlastních integrací.
...
Příležitosti v Arxena CRM jsou potenciální obchody nebo prodeje s účty či kontakty.
...
Úkoly v Arxena CRM jsou přiřazené aktivity týkající se kontaktů, účtů nebo příležitostí.
...
Webhooky jsou automatizované zprávy odesílané z Arxena na jiné aplikace při výskytu specifických událostí, což umožňuje synchronizaci dat v reálném čase.
...
"Pracovní prostor" obvykle představuje společnost používající Arxena. Obsahuje všechny záznamy a data, která vy a členové vašeho týmu do Arxena přidáte.
...
Členové pracovního prostoru jsou uživatelé Arxena z vašeho týmu, kteří mají přístup k vašemu pracovnímu prostoru. Mohou být u záznamů přiřazeni jako vlastníci nebo přiřazené osoby.
