...
description: Zjistěte, jaké akce jsou k dispozici v pracovních postupech Arxena.
---
...
<Note>
E-maily můžete odesílat pouze z poštovních schránek synchronizovaných s vaším vlastním účtem Arxena. Odesílání z poštovních schránek ostatních členů týmu (např. e-mail vlastníka účtu) je v plánu.
</Note>
...
Na pozadí je každá akce Code podpořena vlastní **logickou funkcí** — serverovou funkcí v TypeScriptu, která běží na platformě Arxena. Když přidáte akci Code, Arxena vytvoří pro tento krok vyhrazenou logickou funkci a zobrazí její editor přímo inline, takže kód, který napíšete, zůstává u pracovního postupu.
