---
title: Vytvořte nabídku nebo fakturu z Arxena
...
* [Vygenerovat PDF z Arxena](/l/cs/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-twenty) — připojte vygenerované soubory PDF k záznamům
