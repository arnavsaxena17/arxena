---
title: Vygenerovat PDF z Arxena
description: Vytvořte pracovní postup pro generování a připojení PDF (například nabídky) k záznamu.
---

Automaticky vygenerujte nebo získejte PDF a připojte ho k záznamu v Arxena. To se běžně používá k vytváření nabídek, faktur nebo reportů, které jsou propojené se společnostmi, příležitostmi nebo jinými objekty.
...
* [Vygenerujte nabídku nebo fakturu z Arxena](/l/cs/user-guide/workflows/how-tos/connect-to-other-tools/generate-quote-or-invoice-from-twenty)
