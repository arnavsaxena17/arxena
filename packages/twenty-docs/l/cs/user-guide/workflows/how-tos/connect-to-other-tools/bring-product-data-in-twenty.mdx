---
title: Přeneste produktová data do Arxena
description: Synchronizujte data produktového katalogu z datového skladu do svého CRM podle plánu.
---

Použijte tento vzor k udržení synchronizace Arxena s produktovými daty z vašeho datového skladu (např. Snowflake, BigQuery, PostgreSQL).
...
5. **Upsert Record**: Vytvořte nebo aktualizujte záznam v Arxena
