...
Vztahy typu mnoho-na-mnoho používají vzor zvaný **spojovací objekt**: zprostředkující objekt, který propojuje obě strany. S funkcí spojovacího vztahu zobrazuje Arxena přímo výsledné propojené záznamy a zprostředkující objekt v UI skrývá.
...
Arxena obsahuje předpřipravené relace mezi standardními objekty:
