...
description: Vytvořte skutečnou aplikaci Arxena, která generuje personalizované dokumenty z vašich CRM dat.
---
...
lokální server Arxena běžící na portu `2020` a CLI k němu přihlášené.
