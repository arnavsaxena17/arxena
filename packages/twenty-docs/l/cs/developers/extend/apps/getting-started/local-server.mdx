...
description: Spravujte lokální Docker server Arxena – spouštění, zastavení, upgrade, paralelní testovací instance a ruční nastavení SDK.
icon: server
---

## Správa lokálního serveru

K ovládání lokálního kontejneru Arxena použijte `yarn twenty docker:*`:
