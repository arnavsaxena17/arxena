...
Webhooky posílají data do vašich systémů v reálném čase, když v Arxena dojde k událostem — bez potřeby průběžného dotazování. Použijte je k udržování externích systémů v synchronizaci, spouštění automatizací nebo zasílání upozornění.
...
Arxena odesílá webhooky pro tyto typy událostí:
...
Arxena kvůli bezpečnosti podepisuje každý požadavek webhooku. Ověřujte podpisy, abyste zajistili, že požadavky jsou autentické.
...
| **Spouštěč webhooku v pracovním postupu** | IN   | Přijímejte data do Arxena z externích systémů                   |
