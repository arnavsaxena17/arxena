...
<Tip>
  Arxena を自分で運用・保守したくない場合は？ [認定済みの Arxena ホスティングパートナー](https://arxena.com/partners/list?categories=HOSTING\&ref=docs-docker-compose)に依頼して、インスタンスのデプロイ、ホスティング、管理をエンドツーエンドで任せましょう。 *（または、私たちのチームにご連絡ください: [contact@arxena.com](mailto:contact@arxena.com)。）*
</Tip>
