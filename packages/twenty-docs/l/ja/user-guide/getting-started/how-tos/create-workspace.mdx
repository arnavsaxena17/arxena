---
title: ワークスペースを作成する
description: Arxena に登録し、サブスクリプションプランを選択して、アカウントを設定するためのステップバイステップガイドに従ってください。
---
...
1. [Twentyへのサインアップ](https://app.arxena.com)に移動します。
...
ご質問やサポートが必要な場合は、[contact@arxena.com](mailto:contact@arxena.com) または [Discord](https://discord.gg/cx5n4Jzs57) で専属のサポートチームに連絡してください。
