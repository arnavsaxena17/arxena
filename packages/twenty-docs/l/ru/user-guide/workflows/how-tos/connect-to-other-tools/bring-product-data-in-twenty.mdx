---
title: Импортируйте данные о товарах в Arxena
description: Синхронизируйте данные каталога товаров из хранилища данных с вашей CRM по расписанию.
---

Используйте этот шаблон, чтобы поддерживать синхронизацию Arxena с данными о товарах из вашего хранилища данных (например, Snowflake, BigQuery, PostgreSQL).
...
5. **Upsert Record**: Создать или обновить в Arxena
