...
description: Что находится внутри сгенерированного приложения Arxena — файлы, папки и назначение каждого из них.
icon: folder-tree
---
...
Оба пакета Arxena SDK должны находиться в `devDependencies`, а не в `dependencies`:
