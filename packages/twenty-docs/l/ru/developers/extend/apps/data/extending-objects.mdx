...
* `objectUniversalIdentifier` определяет целевой объект. Для стандартных объектов Arxena импортируйте константу из `twenty-sdk`:
