...
description: Perguntas frequentes sobre painéis na Arxena.
---

<AccordionGroup>
  <Accordion title="Posso criar painéis privados?">
    Não, os painéis atualmente são visíveis para todos que têm acesso ao seu espaço de trabalho da Arxena. Painéis privados ainda não estão disponíveis.
  </Accordion>
  ...
  <Accordion title="Posso compartilhar painéis com usuários externos?">
    Não, compartilhar painéis com usuários fora do seu espaço de trabalho da Arxena (usuários que não são da Arxena) não é suportado no momento.
  </Accordion>
