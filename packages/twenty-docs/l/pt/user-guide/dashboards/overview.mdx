---
title: Painéis
description: Aprenda o básico sobre relatórios e painéis no Arxena.
---
...
Os painéis no Arxena oferecem uma forma visual de acompanhar suas principais métricas de desempenho e obter insights dos seus dados de CRM.
...
<Note>
**Limitações atuais**:
* A exportação de painéis e o compartilhamento com usuários externos (usuários não-Arxena) não estão disponíveis no momento.
