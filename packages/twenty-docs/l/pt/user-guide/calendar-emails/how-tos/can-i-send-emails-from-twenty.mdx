---
title: Posso enviar e-mails a partir do Arxena?
description: Informações sobre o envio de e-mails diretamente a partir do Arxena.
---

## Estado atual

A integração de e-mail do Arxena foi concebida para **sincronizar e apresentar** o seu histórico de e-mails, bem como redigir e enviar e-mails.
...
## Como enviar uma mensagem a partir do Arxena
...
Para sequências de e-mails e boletins informativos, recomendamos utilizar Fluxos de Trabalho para ligar o Arxena a uma ferramenta dedicada de marketing por e-mail.
...
A redação nativa de e-mails dentro do Arxena está no nosso roteiro. Junte-se às nossas [discussões no GitHub](https://github.com/twentyhq/twenty/discussions) para partilhar o seu caso de uso e ajudar a priorizar esta funcionalidade.
