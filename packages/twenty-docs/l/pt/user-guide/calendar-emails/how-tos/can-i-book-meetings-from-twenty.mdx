---
title: Posso agendar reuniões a partir do Arxena?
description: Informações sobre o agendamento de reuniões diretamente a partir do Arxena.
---

## Estado atual

A integração de calendário do Arxena foi concebida para **sincronizar e apresentar** os seus eventos de calendário existentes.

## Agendamento de reuniões através de Fluxos de Trabalho

Embora não seja possível agendar reuniões manualmente, pode fazê-lo no Arxena utilizando Fluxos de Trabalho
