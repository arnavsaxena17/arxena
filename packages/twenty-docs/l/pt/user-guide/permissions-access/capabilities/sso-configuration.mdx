...
O Single Sign-On (SSO) permite que os membros da sua equipe façam login no Arxena usando o provedor de identidade da sua organização. Isso oferece:
...
O Arxena oferece suporte a SSO com:
...
* Acesso de administrador ao workspace do Arxena

<Note>
**Para usuários de auto-hospedagem que desejam configurar SSO**, entre em contato pelo contact@arxena.com
</Note>
...
* **ID da Entidade**: Fornecido pelo Arxena
* **URL ACS**: A URL de retorno para autenticação
* **Certificado**: Para comunicação segura

#### 4. Insira os detalhes do provedor no Arxena
...
* Remova-os do workspace do Arxena
...
* **Mapeamento de grupos**: Mapeie os grupos do IdP para as funções do Arxena (se disponível)
* **Processo de desligamento**: Inclua o Arxena no seu fluxo de trabalho de desprovisionamento
...
<Tip>
  Precisa de SSO configurado para a sua organização? [Encontre um parceiro Arxena certificado](https://arxena.com/partners/list?categories=SOLUTIONING\&ref=docs-sso) que seja especialista em SSO e configuração de identidade. *(Prefere envolver an Arxena diretamente? [contact@arxena.com](mailto:contact@arxena.com).)*
</Tip>
