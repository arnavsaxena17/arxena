...
O Arxena vem com objetos padrão:
...
Cada empresa trabalha de maneira diferente. Personalizar seu modelo de dados significa que você pode moldar o Arxena em torno dos **seus** processos, em vez de forçar os seus a caber em um sistema rígido.

O Arxena oferece total flexibilidade:
...
Identifique os principais conceitos com os quais você trabalha. O Arxena já oferece:
...
<Tip>
  ...
  * **Feito para você:** [encontre um parceiro Arxena certificado](https://arxena.com/partners/list?categories=SOLUTIONING\&ref=docs-data-model) para projetar e criar seus objetos, campos e relacionamentos.
  * **Pacote de onboarding:** uma sessão guiada de 4 horas para projetar o modelo de dados com a nossa equipe — [contact@arxena.com](mailto:contact@arxena.com). Veja [Serviços de Implementação](/l/pt/user-guide/getting-started/capabilities/implementation-services).
</Tip>
