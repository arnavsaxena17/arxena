---
title: IA
description: Funcionalidades com IA no Arxena.
---
...
Atualmente, o Arxena oferece:

### 1. Chatbot de IA

Um assistente conversacional que entende seu contexto e tem acesso a todos os seus dados do Arxena.

**Principais capacidades:**

* **Acesso completo aos dados**: Consulte qualquer registro, relacionamento ou métrica no seu espaço de trabalho
* **Consciência do contexto da página**: Faça referência a "esta empresa" ou "esta oportunidade" com base em onde você está no Arxena
