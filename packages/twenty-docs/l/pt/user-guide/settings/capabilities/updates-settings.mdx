...
description: Ative recursos de Acesso antecipado no Arxena.
---
...
<Note>
Os recursos de Acesso antecipado podem mudar com base no feedback dos usuários. Seu feedback ajuda a melhorar o Arxena!
</Note>

## Comentários sobre os recursos

Seu feedback ajuda a melhorar o Arxena:
