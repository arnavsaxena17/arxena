...
description: Perguntas frequentes sobre as configurações do Arxena.
---
...
Para alterar seu endereço de e-mail, entre em contato pelo [contact@arxena.com](mailto:contact@arxena.com).
</Accordion>
...
* **Subdomínio**: Use um subdomínio do Arxena como `yourcompany.arxena.com`
