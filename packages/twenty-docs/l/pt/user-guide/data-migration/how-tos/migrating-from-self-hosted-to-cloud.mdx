...
description: Guia passo a passo para migrar a sua instância Arxena auto-hospedada para an Arxena Cloud.
---

## Visão Geral

Este guia orienta-o na migração dos seus dados de uma instância Arxena auto-hospedada para an Arxena Cloud. O processo envolve configurar o seu espaço de trabalho na cloud, exportar os seus dados e voltar a importá-los.
...
1. Aceda a [app.arxena.com](https://app.arxena.com) e crie um novo espaço de trabalho
...
<Tip>
  Migrando um espaço de trabalho grande ou complexo? [Encontre um parceiro Arxena certificado](https://arxena.com/partners/list?categories=HOSTING\&ref=docs-migrate-cloud) para cuidar da migração de ponta a ponta. *(Ou envolva a nossa equipe: [contact@arxena.com](mailto:contact@arxena.com).)*
</Tip>
