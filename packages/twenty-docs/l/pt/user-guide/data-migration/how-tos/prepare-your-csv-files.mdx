...
description: Guia completo passo a passo para formatar seus dados para importação no Arxena.
---
...
**Esta é a etapa mais importante.** O arquivo de exemplo mostra os nomes exatos das colunas e o formato que o Arxena espera.
...
O Arxena impõe unicidade em determinados campos. Duplicados causarão erros de importação.
...
3. Verifique se há duplicados que já existem no Arxena
...
* Deve ser exclusivo (sem duplicados no arquivo ou no Arxena)
...
* Deve ser exclusivo dentro do seu arquivo e no Arxena
...
* **Links / Rótulo do Link**: `Arxena`
* **Links / URL do Link**: `https://arxena.com`
...
* **Opcional**: an Arxena gera IDs automaticamente se não forem fornecidos
...
* O registro pai já deve existir na Arxena
...
## Etapa 6: Garanta que os campos existam na Arxena
