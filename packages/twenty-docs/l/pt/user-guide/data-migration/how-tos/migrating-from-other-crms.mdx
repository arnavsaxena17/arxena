...
description: Guia passo a passo para migrar os seus dados de qualquer CRM para o Arxena.
---

## Visão Geral

Este guia explica como migrar os seus dados de qualquer CRM para o Arxena. O processo envolve auditar os seus dados, preparar o seu espaço de trabalho no Arxena, exportar do seu sistema atual e importar para o Arxena.
...
Crie um documento de mapeamento entre o seu CRM atual e o Arxena:
...
## Passo 3: Configure o seu espaço de trabalho no Arxena

Antes de importar dados, prepare o seu espaço de trabalho no Arxena:
...
Se os seus dados incluírem referências a utilizadores (Proprietário da conta, Responsável, etc.), esses utilizadores devem existir no Arxena antes da importação. Caso contrário, essas relações não podem ser mapeadas.
</Warning>
...
Abra cada CSV exportado numa aplicação de folha de cálculo e prepare-o para o Arxena.

### Remova duplicados

1. Ordene pelo campo único (e-mail para Pessoas, domínio para Empresas)
2. Remova ou una linhas duplicadas
3. Verifique se não existem já duplicados no Arxena
...
Use `https://domain.com` (não `domain.com` nem `www.domain.com`). Isto corresponde ao formato do Arxena e evita duplicados quando ligar a sincronização de e-mail/calendário.
</Warning>
...
2. Use os mesmos endereços de e-mail que os utilizadores usaram para aderir ao seu espaço de trabalho no Arxena
...
1. Navegue até ao objeto no Arxena
...
* O Arxena começará a sincronizar e-mails com os registos de contactos
...
<AccordionGroup>
  <Accordion title="Posso migrar fluxos de trabalho automaticamente?">
    De momento, não. Os fluxos de trabalho devem ser recriados manualmente no Arxena.
  </Accordion>
...
<Tip>
  ...
  * **Feito para você:** [encontre um parceiro Arxena certificado](https://arxena.com/partners/list?categories=SOLUTIONING\&ref=docs-migrate-crm) para mover seus dados, funis e usuários de ponta a ponta.
  * **Pacote de onboarding:** uma configuração guiada de 4 horas com a nossa equipe — [contact@arxena.com](mailto:contact@arxena.com).
</Tip>
