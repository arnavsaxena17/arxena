...
description: Saiba mais sobre os planos de preços do Arxena e como alternar entre eles.
---

## Visão Geral

O Arxena oferece preços flexíveis para atender equipes de todos os tamanhos, quer você prefira hospedagem em nuvem ou auto-hospedagem.
...
Hospede o Arxena na sua própria infraestrutura sem custo:
