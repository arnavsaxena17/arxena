...
description: Siga um guia passo a passo sobre como se registrar na Arxena, escolher um plano de assinatura e configurar sua conta.
---
...
1. Navegue até [Cadastro Arxena](https://app.arxena.com).
...
Para dúvidas ou ajuda, conecte-se com a equipe de suporte dedicada em [contact@arxena.com](mailto:contact@arxena.com) ou envie uma mensagem no [Discord](https://discord.gg/cx5n4Jzs57).
