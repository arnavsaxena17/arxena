...
O menu de comandos oferece **acesso rápido a ações** no Arxena. Você pode acessá-lo de duas maneiras:
...
* Acessar registros excluídos (Arxena dá suporte a exclusões lógicas e permanentes)
