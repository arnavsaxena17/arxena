...
Você quer marcar um colega em uma nota para que receba uma notificação para revisá-la. Hoje, an Arxena não oferece suporte a @mentions em notas ou tarefas.
...
<Note>
Substitua `yourSubDomain` pelo subdomínio real do seu espaço de trabalho Arxena.
</Note>
