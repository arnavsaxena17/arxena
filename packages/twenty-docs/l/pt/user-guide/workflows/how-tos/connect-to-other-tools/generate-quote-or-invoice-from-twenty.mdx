---
title: Gerar um orçamento ou fatura no Arxena
...
* [Gerar um PDF a partir do Arxena](/l/pt/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-twenty) — anexar PDFs gerados aos registros
