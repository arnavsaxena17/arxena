...
description: Aprenda a criar automações no Arxena.
---

## Por que Workflows Importam

Arxena foi criado para trazer flexibilidade máxima aos seus usuários. Em vez de forçá-lo a adaptar seus processos de negócios a recursos rígidos e pré-construídos, os workflows permitem que você crie automações que criem o CRM que melhor apoie seus casos de uso de negócios exclusivos.

Workflows são o recurso interno de Arxena para criar essas automações. Eles oferecem os blocos de construção para criar exatamente o que seu negócio precisa, quando precisa.
...
2. **Traga dados para dentro e para fora do Arxena**: Conecte-se ao Arxena por meio de chamadas de API e webhooks para seu banco de dados e outras ferramentas.
...
* **Formulário**: Obter entradas de usuários na interface do Arxena no momento da execução
...
<Tip>
  ...
  * **Feito para você:** [encontre um parceiro Arxena certificado](https://arxena.com/partners/list?categories=SOLUTIONING\&ref=docs-workflows) para projetar e construir suas automações de ponta a ponta.
  * **Pacote de onboarding:** uma sessão guiada de 4 horas para criação de fluxos de trabalho com a nossa equipe — [contact@arxena.com](mailto:contact@arxena.com).
</Tip>
