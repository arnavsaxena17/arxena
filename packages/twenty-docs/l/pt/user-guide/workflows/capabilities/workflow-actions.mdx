...
description: Saiba mais sobre as ações disponíveis nos fluxos de trabalho do Arxena.
---
...
<Note>
Você só pode enviar e-mails de caixas de correio sincronizadas com a sua própria conta Arxena. O envio a partir das caixas de correio de outros membros da equipe (por exemplo, o e-mail do proprietário da conta) está no roadmap.
</Note>
...
Nos bastidores, cada ação de código é respaldada por sua própria **função lógica** — uma função TypeScript do lado do servidor que é executada na plataforma Arxena. Quando você adiciona uma ação de código, o Arxena cria uma função lógica dedicada para essa etapa e exibe seu editor em linha, de modo que o código que você escreve fica junto com o fluxo de trabalho.
