...
description: O que há dentro de um app Arxena criado com scaffold — arquivos, pastas e o que cada um faz.
icon: folder-tree
---
...
Ambos os pacotes Arxena SDK pertencem a `devDependencies`, não a `dependencies`:
