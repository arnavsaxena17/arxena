...
description: Gerencie o servidor Docker local do Arxena — iniciar, parar, atualizar, executar uma instância de teste paralela e configurar manualmente o SDK.
icon: server
---

## Gerenciando o servidor local

Use `yarn twenty docker:*` para controlar o contêiner Arxena local:
