...
sandboxed dentro de Arxena. Ours lê o registro selecionado, carrega o modelo de pessoa
...
`RICH_TEXT`, Arxena já fornece um editor de rich text completo para ele — o
