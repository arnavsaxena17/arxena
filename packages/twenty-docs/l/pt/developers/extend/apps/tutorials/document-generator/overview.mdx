...
description: Crie um aplicativo Arxena real que gera documentos personalizados a partir dos seus dados de CRM.
---
...
um servidor Arxena local em execução na porta `2020` e o CLI autenticado nele.
