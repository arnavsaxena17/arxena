...
Os webhooks enviam dados para seus sistemas em tempo real quando eventos ocorrem no Arxena — sem necessidade de polling. Use-os para manter sistemas externos em sincronia, acionar automações ou enviar alertas.
...
O Arxena envia webhooks para estes tipos de eventos:
...
O Arxena assina cada solicitação de webhook por segurança. Valide as assinaturas para garantir que as solicitações sejam autênticas.
...
| **Gatilho de webhook de fluxo de trabalho** | ENTRADA | Receber dados no Arxena a partir de sistemas externos                            |
