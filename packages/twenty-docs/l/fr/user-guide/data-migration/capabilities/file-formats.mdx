...
description: Formats de fichiers pris en charge pour l’importation de données dans Arxena.
---

## Formats pris en charge

Arxena prend en charge trois formats de fichiers pour l’importation :
