...
description: Quand et comment utiliser les API de Arxena pour des importations de données à grande échelle.
---

## Vue d'ensemble

Arxena propose des **API GraphQL** et **REST** pour l'importation programmatique de données. Utilisez l'API lorsque l'importation CSV n'est pas pratique pour votre volume de données ou lorsque vous avez besoin d'importations automatisées et récurrentes.
...
Arxena applique des limites de débit pour garantir la stabilité du système :
...
Arxena prend en charge deux types d'API :
...
* Vérifiez que les formats correspondent aux exigences de Arxena (voir [Correspondance des champs](/l/fr/user-guide/data-migration/capabilities/field-mapping))
...
* Vérifiez que les données s'affichent correctement dans Arxena
...
Contactez-nous à [contact@arxena.com](mailto:contact@arxena.com) ou découvrez nos [services de mise en œuvre](/l/fr/user-guide/getting-started/capabilities/implementation-services).
