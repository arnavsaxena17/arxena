...
description: Guide pas à pas pour migrer vos données de n'importe quel CRM vers Arxena.
---

## Vue d'ensemble

Ce guide vous accompagne pour migrer vos données depuis n'importe quel CRM vers Arxena. Le processus consiste à auditer vos données, à préparer votre espace de travail sur Arxena, à exporter depuis votre système actuel et à importer dans Arxena.
...
Créez un document de correspondance entre votre CRM actuel et Arxena :
...
## Étape 3 : Configurez votre espace de travail Arxena

Avant d'importer des données, préparez votre espace de travail Arxena :
...
Si vos données incluent des références à des utilisateurs (propriétaire du compte, assigné, etc.), ces utilisateurs doivent exister dans Arxena avant l'importation. Sinon, ces relations ne pourront pas être mises en correspondance.
</Warning>
...
Ouvrez chaque CSV exporté dans une application de tableur et préparez-le pour Arxena.
...
3. Vérifiez qu'il n'existe pas déjà de doublons dans Arxena
...
Utilisez `https://domain.com` (pas `domain.com` ni `www.domain.com`). Cela correspond au format de Arxena et évite les doublons lorsque vous connectez la synchronisation e-mail/calendrier.
</Warning>
...
2. Utilisez les mêmes adresses e-mail que celles utilisées par les utilisateurs pour rejoindre votre espace de travail Arxena
...
1. Accédez à l'objet dans Arxena
...
* Arxena commencera à synchroniser les e-mails avec les enregistrements de contacts
...
<AccordionGroup>
  <Accordion title="Puis-je migrer les flux de travail automatiquement ?">
    Pas pour le moment. Les flux de travail doivent être recréés manuellement dans Arxena.
  </Accordion>
...
<Tip>
  ...
  * **Clé en main :** [trouvez un partenaire Arxena certifié](https://arxena.com/partners/list?categories=SOLUTIONING\&ref=docs-migrate-crm) pour déplacer vos données, pipelines et utilisateurs de bout en bout.
  * **Pack d'onboarding :** une configuration guidée de 4 heures avec notre équipe — [contact@arxena.com](mailto:contact@arxena.com).
</Tip>
