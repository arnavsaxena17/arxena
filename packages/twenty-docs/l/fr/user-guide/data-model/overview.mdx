...
Arxena inclut des objets standard :
...
Chaque entreprise fonctionne différemment. La personnalisation de votre modèle de données vous permet de façonner Arxena autour de **vos** processus au lieu de forcer les vôtres dans un système rigide.

Arxena offre une flexibilité totale :
...
Identifiez les principaux concepts avec lesquels vous travaillez. Arxena propose déjà :
...
<Tip>
  ...
  * **Clé en main :** [trouvez un partenaire Arxena certifié](https://arxena.com/partners/list?categories=SOLUTIONING\&ref=docs-data-model) pour concevoir et construire vos objets, champs et relations.
  * **Pack d'onboarding :** une session guidée de conception de modèle de données de 4 heures avec notre équipe — [contact@arxena.com](mailto:contact@arxena.com). Voir [services d'implémentation](/l/fr/user-guide/getting-started/capabilities/implementation-services).
</Tip>
