...
L'authentification unique (SSO) permet aux membres de votre équipe de se connecter à Arxena en utilisant le fournisseur d'identité de votre organisation. Cela offre :
...
Arxena prend en charge le SSO avec :
...
* Accès administrateur à l'espace de travail Arxena

<Note>
**Pour les utilisateurs en auto-hébergement souhaitant configurer le SSO**, contactez contact@arxena.com
</Note>
...
* Retirez-les de l'espace de travail Arxena
...
* **Correspondance de groupes** : Faites correspondre les groupes IdP aux rôles Arxena (si disponible)
* **Processus de départ** : Incluez Arxena dans votre workflow de déprovisionnement
...
<Tip>
  Vous avez besoin de configurer le SSO pour votre organisation ? [Trouvez un partenaire Arxena certifié](https://arxena.com/partners/list?categories=SOLUTIONING\&ref=docs-sso) spécialisé en SSO et en gestion des identités. *(Vous préférez impliquer directement Arxena ? [contact@arxena.com](mailto:contact@arxena.com).)*
</Tip>
