...
Le menu de commandes vous donne **un accès rapide aux actions** dans Arxena. Vous pouvez y accéder de deux manières :
...
* Accéder aux enregistrements supprimés (Arxena prend en charge les suppressions logiques et définitives)
