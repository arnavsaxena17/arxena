...
description: Suivez un guide étape par étape expliquant comment s'inscrire sur Arxena, choisir un plan d'abonnement et configurer votre compte.
---
...
1. Allez sur [Inscription à Arxena](https://app.arxena.com).
...
Pour toute question ou aide, contactez l'équipe de support dédiée à [contact@arxena.com](mailto:contact@arxena.com) ou envoyez un message sur [Discord](https://discord.gg/cx5n4Jzs57).
