---
title: Générer un devis ou une facture depuis Arxena
...
* [Générer un PDF à partir de Arxena](/l/fr/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-twenty) — joindre les PDF générés aux enregistrements
