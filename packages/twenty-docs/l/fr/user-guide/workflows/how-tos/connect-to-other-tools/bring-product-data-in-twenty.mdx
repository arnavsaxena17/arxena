---
title: Importer les données de produits dans Arxena
...
Utilisez ce modèle pour garder Arxena synchronisé avec les données produits de votre entrepôt de données (par ex. Snowflake, BigQuery, PostgreSQL).
...
5. **Upsert Record** : Créer ou mettre à jour dans Arxena
