...
description: Foire aux questions sur les paramètres de Arxena.
---
...
Pour changer votre adresse e-mail, veuillez contacter [contact@arxena.com](mailto:contact@arxena.com).
</Accordion>
...
* **Sous-domaine** : Utilisez un sous-domaine Arxena comme `yourcompany.arxena.com`
