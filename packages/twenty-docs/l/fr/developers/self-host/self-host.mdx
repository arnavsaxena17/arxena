...
description: Déployez et gérez Arxena sur votre propre infrastructure.
---
...
Arxena peut être auto-hébergé sur votre propre infrastructure, vous offrant un contrôle total sur vos données et votre déploiement.
