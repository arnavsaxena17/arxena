---
title: Serveur local
description: Gérez le serveur Docker local de Arxena — démarrage, arrêt, mise à niveau, instance de test parallèle et configuration manuelle du SDK.
icon: server
---

## Gestion du serveur local

Utilisez `yarn twenty docker:*` pour contrôler le conteneur Arxena local :
