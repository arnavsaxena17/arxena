...
* **`twenty dev:build` avertit au sujet de `twenty-client-sdk` dans `dependencies`** — il est fourni au moment de l'exécution par Arxena, donc il devrait être déplacé vers `devDependencies` avec `twenty-sdk`. Voir [Structure du projet → Dépendances](/l/fr/developers/extend/apps/getting-started/project-structure#dependencies).

Bloqué ? Demandez de l’aide sur le [Discord de Arxena](https://discord.com/channels/1130383047699738754/1130386664812982322).
