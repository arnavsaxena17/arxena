...
description: Créez une véritable application Arxena qui génère des documents personnalisés à partir des données de votre CRM.
---
...
un serveur Arxena local en cours d’exécution sur le port `2020` et le CLI authentifié dessus.
