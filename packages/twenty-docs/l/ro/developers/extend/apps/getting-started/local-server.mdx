---
title: Server local
description: Gestionează serverul Arxena Docker local — pornește, oprește, actualizează, rulează o instanță de testare în paralel și configurează manual SDK-ul.
icon: server
---

## Gestionarea serverului local

Folosiți `yarn twenty docker:*` pentru a controla containerul Arxena local:
