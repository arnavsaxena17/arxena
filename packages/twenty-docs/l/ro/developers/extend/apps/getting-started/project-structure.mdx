...
description: Ce conține o aplicație Arxena generată — fișiere, foldere și ce face fiecare.
icon: folder-tree
---
...
Ambele pachete Arxena SDK trebuie plasate sub `devDependencies`, nu sub `dependencies`:
