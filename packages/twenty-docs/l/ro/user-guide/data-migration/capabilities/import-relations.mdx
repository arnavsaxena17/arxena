...
Arxena acceptă importul relațiilor dintre obiecte în timpul importului CSV. Acest lucru vă permite să conectați înregistrări (de ex., să atașați Persoane la Companii) ca parte a migrării datelor.
...
## Cum funcționează relațiile în Arxena

### Unu la mulți / Mulți la unu

Arxena acceptă relații standard în care o înregistrare se leagă de multe altele:
...
Înainte de a importa partea „mulți”, înregistrările de pe partea „unu” trebuie să existe deja în Arxena.
...
4. Arxena va lega automat fiecare înregistrare de părintele corespunzător
...
<Note>**Conectarea la Membrii Workspace-ului**: Când relația indică către Membrii Workspace-ului (echipa dvs. care se autentifică în Arxena), referiți-vă la ei prin **adresa de email**, nu prin nume.</Note>
