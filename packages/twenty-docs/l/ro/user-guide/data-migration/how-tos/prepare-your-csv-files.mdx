...
description: Ghid complet, pas cu pas, pentru a formata datele pentru import în Arxena.
---
...
**Acesta este cel mai important pas.** Fișierul de mostră vă arată exact denumirile de coloane și formatul pe care îl așteaptă Arxena.
...
Arxena impune unicitatea pentru anumite câmpuri. Valorile duplicate vor provoca erori la import.
...
3. Verificați duplicatele care există deja în Arxena
...
* Trebuie să fie unic (fără duplicate în fișier sau în Arxena)
...
* Trebuie să fie unic în fișierul dvs. și în Arxena
...
* **Linkuri / Etichetă link**: `Arxena`
* **Linkuri / URL link**: `https://arxena.com`
...
* **Opțional**: Arxena generează automat ID-uri dacă nu sunt furnizate
...
* Înregistrarea părinte trebuie să existe deja în Arxena
...
## Pasul 6: Asigurați-vă că câmpurile există în Arxena
