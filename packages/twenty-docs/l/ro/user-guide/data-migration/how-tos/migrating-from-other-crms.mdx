...
description: Ghid pas cu pas pentru migrarea datelor din orice CRM către Arxena.
---

## Prezentare generală

Acest ghid vă ghidează prin procesul de migrare a datelor din orice CRM către Arxena. Procesul implică auditarea datelor, pregătirea spațiului de lucru Arxena, exportul din sistemul curent și importul în Arxena.
...
Creați un document de mapare între CRM-ul curent și Arxena:
...
## Pasul 3: Configurați spațiul dvs. de lucru Arxena

Înainte de a importa date, pregătiți spațiul dvs. de lucru Arxena:
...
Dacă datele dvs. includ referințe la utilizatori (Proprietar cont, Atribuit etc.), acei utilizatori trebuie să existe în Arxena înainte de import. În caz contrar, acele relații nu pot fi mapate.
</Warning>
...
Deschideți fiecare CSV exportat într-o aplicație de calcul tabelar și pregătiți-l pentru Arxena.
...
3. Verificați că nu există deja duplicate în Arxena
...
Folosiți `https://domain.com` (nu `domain.com` sau `www.domain.com`). Acest lucru corespunde formatului Arxena și previne duplicatele când conectați sincronizarea e-mailului/calendarului.
</Warning>
...
2. Folosiți aceleași adrese de e-mail pe care utilizatorii le-au folosit pentru a se alătura spațiului dvs. de lucru Arxena
...
1. Navigați la obiect în Arxena
...
* Arxena va începe să sincronizeze e-mailurile cu înregistrările de contact
...
<AccordionGroup>
  <Accordion title="Pot migra fluxurile de lucru automat?">
    Momentan, nu. Fluxurile de lucru trebuie recreate manual în Arxena.
  </Accordion>
...
<Tip>
  ...
  * **Realizat pentru tine:** [găsește un partener Arxena certificat](https://arxena.com/partners/list?categories=SOLUTIONING\&ref=docs-migrate-crm) care să îți mute datele, pipeline-urile și utilizatorii de la un capăt la altul.
  * **Pachet de onboarding:** o configurare asistată de 4 ore împreună cu echipa noastră — [contact@arxena.com](mailto:contact@arxena.com).
</Tip>
