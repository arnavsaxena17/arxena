...
description: Când și cum să utilizați API-urile Arxena pentru importuri de date la scară mare.
---

## Prezentare generală

Arxena oferă atât **GraphQL**, cât și **API-uri REST** pentru importul programatic de date. Utilizați API-ul când importul CSV nu este practic pentru volumul dvs. de date sau când aveți nevoie de importuri automate, recurente.
...
Arxena impune limitări de rată pentru a asigura stabilitatea sistemului:
...
Arxena acceptă două tipuri de API:
...
* Verificați că formatele corespund cerințelor Arxena (consultați [Maparea câmpurilor](/l/ro/user-guide/data-migration/capabilities/field-mapping))
...
* Verificați că datele apar corect în Arxena
...
Contactați-ne la [contact@arxena.com](mailto:contact@arxena.com) sau explorați [Serviciile noastre de implementare](/l/ro/user-guide/getting-started/capabilities/implementation-services).
