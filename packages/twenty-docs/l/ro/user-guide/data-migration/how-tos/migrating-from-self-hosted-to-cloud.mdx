...
description: Ghid pas cu pas pentru migrarea instanței Arxena auto-găzduite la Arxena Cloud.
---

## Prezentare generală

Acest ghid vă ghidează prin migrarea datelor dvs. dintr-o instanță Arxena auto-găzduită către Arxena Cloud. Procesul presupune configurarea spațiului dvs. de lucru în cloud, exportarea datelor și reimportarea acestora.
...
1. Accesați [app.arxena.com](https://app.arxena.com) și creați un nou spațiu de lucru
...
<Tip>
  Migrați un spațiu de lucru mare sau complex? [Găsiți un partener Arxena certificat](https://arxena.com/partners/list?categories=HOSTING\&ref=docs-migrate-cloud) care să gestioneze migrarea de la un capăt la altul. *(Sau implicați echipa noastră: [contact@arxena.com](mailto:contact@arxena.com).)*
</Tip>
