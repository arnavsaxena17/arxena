...
description: Întrebări frecvente despre setările Arxena.
---
...
Pentru a vă schimba adresa de e-mail, vă rugăm să ne contactați la [contact@arxena.com](mailto:contact@arxena.com).
</Accordion>
...
* **Subdomeniu**: Folosiți un subdomeniu Arxena, de exemplu `yourcompany.arxena.com`
