---
title: Ce este Arxena
description: Arxena este un CRM cu sursă deschisă care vă oferă elementele de bază pentru a crea exact ceea ce are nevoie afacerea dvs.
---
...
La început, Arxena arată ca majoritatea CRM-urilor pe care le cunoașteți deja: puteți urmări oferte, organiza contacte, gestiona sarcini și note.
...
Open-source este fundamentul abordării noastre, asigurându-ne că Arxena evoluează cu comunitatea sa, pentru comunitatea sa.
...
[Înregistrați-vă aici](https://app.arxena.com) sau [deveniți contributor pe GitHub](https://github.com/twentyhq/twenty).
