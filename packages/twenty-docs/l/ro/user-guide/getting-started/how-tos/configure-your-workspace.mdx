...
description: Fiecare afacere funcționează diferit. Începeți cu acești 3 pași pentru a adapta Arxena la nevoile dvs.
---

<Note>**Rezultat rapid**: Începeți prin conectarea căsuței de e-mail. Acest lucru îți oferă valoare imediată și ajută echipa ta să vadă Arxena în acțiune cu date reale. Puteți face acest lucru în Setări → Conturi.</Note>

## 1. Personalizează modelul tău de date

Arxena oferă flexibilitatea de care ai nevoie pentru a modela modelul de date care va susține cel mai bine activitățile tale zilnice.
...
Importarea datelor existente în Arxena oferă echipei tale context de la început.

### Conectează-ți căsuța de e-mail

Dacă nu ai făcut asta atunci când ai creat spațiul de lucru, conectează-ți **contul Google sau Microsoft** în setări → Conturi. Acest lucru permite Arxena să:
