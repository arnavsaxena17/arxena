...
description: Urmați un ghid pas cu pas despre cum să vă înregistrați pe Arxena, să alegeți un plan de abonament și să vă configurați contul.
---
...
1. Navigați la [Arxena Sign Up](https://app.arxena.com).
...
Pentru întrebări sau ajutor, contactați echipa de suport dedicată la [contact@arxena.com](mailto:contact@arxena.com) sau trimiteți un mesaj pe [Discord](https://discord.gg/cx5n4Jzs57).
