...
Single Sign-On (SSO) le permite membrilor echipei dvs. să se autentifice în Arxena folosind furnizorul de identitate al organizației dvs. Acest lucru oferă:
...
* Acces de administrator la spațiul de lucru Arxena

<Note>
**Pentru utilizatorii care se auto-găzduiesc și doresc să configureze SSO**, contactați contact@arxena.com
</Note>
...
* Eliminați-i din spațiul de lucru Arxena
...
* **Maparea grupurilor**: Mapați grupurile IdP la rolurile Arxena (dacă este disponibilă)
* **Proces de offboarding**: Includeți Arxena în fluxul dvs. de deprovisionare
...
<Tip>
  Aveți nevoie de configurarea SSO pentru organizația dvs.? [Găsiți un partener Arxena certificat](https://arxena.com/partners/list?categories=SOLUTIONING\&ref=docs-sso) specializat în SSO și configurarea identității. *(Preferiți să implicați Arxena direct? [contact@arxena.com](mailto:contact@arxena.com).)*
</Tip>
