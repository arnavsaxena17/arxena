---
title: Generați o ofertă sau o factură din Arxena
...
* [Generați un PDF din Arxena](/l/ro/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-twenty) — atașați PDF-uri generate la înregistrări
