...
title: Aplicaciones
icon: cube
description: "Amplía Arxena con código: objetos personalizados, lógica del lado del servidor, componentes de IU y agentes de IA, todo como paquetes de TypeScript."
---

La mayoría de los CRM te dan un panel de configuración. Arxena te da una plataforma. Las aplicaciones son la forma en que los desarrolladores amplían Arxena más allá de lo que ofrece la IU: definen modelos de datos, lógica del lado del servidor, componentes de IU y capacidades de IA como código, y luego los implementan en uno o más espacios de trabajo.
...
| **Componentes de frontend** | Componentes de React aislados (sandboxed) que se renderizan dentro de la interfaz de Arxena (panel lateral, widgets, menú de comandos) |
