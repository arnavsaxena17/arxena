...
info: Aprende cómo puedes colaborar con Arxena en Figma
---
...
1. **Accede al enlace compartido:** Puedes acceder al archivo de Figma del proyecto [aquí](https://www.figma.com/file/xt8O9mFeLl46C5InWwoMrN/Arxena).
...
En la barra lateral izquierda, puedes acceder a las diferentes páginas del Figma de Arxena. Así es como están organizadas:
