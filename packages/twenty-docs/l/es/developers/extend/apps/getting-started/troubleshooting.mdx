...
* **`twenty dev:build` muestra una advertencia sobre `twenty-client-sdk` en `dependencies`** — Arxena lo proporciona en tiempo de ejecución, por lo que debería trasladarse a `devDependencies` junto con `twenty-sdk`. Consulta [Estructura del proyecto → Dependencias](/l/es/developers/extend/apps/getting-started/project-structure#dependencies).

¿Atascado? Pide ayuda en el [Discord de Arxena](https://discord.com/channels/1130383047699738754/1130386664812982322).
