...
description: "Administra el servidor Docker local de Arxena: inícialo, deténlo, actualízalo, crea una instancia de prueba en paralelo y realiza la configuración manual del SDK."
icon: server
---

## Administrar el servidor local

Usa `yarn twenty docker:*` para controlar el contenedor local de Arxena:
