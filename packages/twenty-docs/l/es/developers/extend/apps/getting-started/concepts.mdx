---
title: Conceptos
description: "Cómo funcionan las aplicaciones de Arxena: modelo de entidad, sandboxing y ciclo de vida de la instalación."
icon: sitemap
---

Las aplicaciones de Arxena son paquetes de TypeScript que amplían tu espacio de trabajo con objetos personalizados, lógica, componentes de UI y capacidades de IA. Se ejecutan en la plataforma Arxena con sandboxing completo y controles de permisos.
...
| **Componente de frontend**          | Interfaz de usuario de React en entorno aislado dentro de Arxena | [Componentes de frontend](/l/es/developers/extend/apps/layout/front-components)               |
...
* **Los componentes de frontend** se ejecutan en Web Workers usando Remote DOM — aislados de la página principal pero renderizando elementos DOM nativos (no iframes). Se comunican con Arxena a través de una API de host de paso de mensajes.
...
* **`yarn twenty dev`** — observa tus archivos fuente y sincroniza en tiempo real los cambios con un servidor de Arxena conectado. El cliente de API tipado se regenera automáticamente cuando cambia el esquema.
