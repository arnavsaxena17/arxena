...
* Los predicados pueden hacer referencia a objetos y campos que sean propiedad de tu aplicación o de los objetos estándar de Arxena.
...
export default defineApplicationRole({
  ...
  description: 'Default role for function Arxena client',
