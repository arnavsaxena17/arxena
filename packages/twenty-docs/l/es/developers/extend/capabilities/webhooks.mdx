...
Los webhooks envían datos a tus sistemas en tiempo real cuando ocurren eventos en Arxena — no se requiere sondeo. Úsalos para mantener sincronizados los sistemas externos, activar automatizaciones o enviar alertas.
...
Arxena envía webhooks para estos tipos de eventos:
...
Arxena firma cada solicitud de webhook por seguridad. Valida las firmas para garantizar que las solicitudes sean auténticas.
...
| **Disparador de webhook de flujo de trabajo** | ENTRADA   | Recibir datos en Arxena desde sistemas externos                                   |
