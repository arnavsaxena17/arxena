...
description: Siga una guía paso a paso sobre cómo registrarse en Arxena, elegir un plan de suscripción y configurar su cuenta.
---
...
1. Dirígete a [Arxena Sign Up](https://app.arxena.com).
...
Para consultas o ayuda, contacta con el equipo de soporte dedicado en [contact@arxena.com](mailto:contact@arxena.com) o envía un mensaje por [Discord](https://discord.gg/cx5n4Jzs57).
