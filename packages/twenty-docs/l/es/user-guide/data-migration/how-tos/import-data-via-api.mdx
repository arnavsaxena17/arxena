...
description: Cuándo y cómo usar las API de Arxena para importaciones de datos a gran escala.
---

## Resumen

Arxena ofrece tanto **GraphQL** como **API REST** para la importación programática de datos. Utiliza la API cuando la importación mediante CSV no sea práctica para tu volumen de datos o cuando necesites importaciones automatizadas y recurrentes.
...
Arxena aplica límites de tasa para garantizar la estabilidad del sistema:
...
Arxena admite dos tipos de API:
...
* Verifica que los formatos cumplan los requisitos de Arxena (consulta [Asignación de campos](/l/es/user-guide/data-migration/capabilities/field-mapping))
...
* Verifica que los datos aparezcan correctamente en Arxena
...
Contáctanos en [contact@arxena.com](mailto:contact@arxena.com) o explora nuestros [Servicios de implementación](/l/es/user-guide/getting-started/capabilities/implementation-services).
