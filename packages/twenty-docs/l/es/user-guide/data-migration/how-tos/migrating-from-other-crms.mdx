...
description: Guía paso a paso para migrar tus datos desde cualquier CRM an Arxena.
---

## Resumen

Esta guía te lleva paso a paso para migrar tus datos desde cualquier CRM an Arxena. El proceso implica auditar tus datos, preparar tu espacio de trabajo de Arxena, exportar desde tu sistema actual e importar en Arxena.
...
Crea un documento de mapeo entre tu CRM actual y Arxena:
...
## Paso 3: Configura tu espacio de trabajo en Arxena

Antes de importar datos, prepara tu espacio de trabajo en Arxena:
...
Si tus datos incluyen referencias a usuarios (propietario de la cuenta, asignado, etc.), esos usuarios deben existir en Arxena antes de la importación. De lo contrario, esas relaciones no se podrán asignar.
</Warning>
...
Abre cada CSV exportado en una aplicación de hojas de cálculo y prepáralo para Arxena.

### Elimina duplicados

1. Ordena por el campo único (correo electrónico para Personas, dominio para Empresas)
2. Elimina o combina filas duplicadas
3. Verifica que no existan duplicados ya en Arxena
...
Usa `https://domain.com` (no `domain.com` ni `www.domain.com`). Esto coincide con el formato de Arxena y evita duplicados cuando conectas la sincronización de correo/calendario.
</Warning>
...
2. Usa las mismas direcciones de correo electrónico que los usuarios utilizaron para unirse a tu espacio de trabajo en Arxena
...
1. Navega hasta el objeto en Arxena
...
* Arxena comenzará a sincronizar los correos electrónicos con los registros de contactos
...
<AccordionGroup>
  <Accordion title="¿Puedo migrar los flujos de trabajo automáticamente?">
    Actualmente no. Los flujos de trabajo deben recrearse manualmente en Arxena.
  </Accordion>
...
<Tip>
  ...
  * **Hecho para ti:** [encuentra un partner certificado de Arxena](https://arxena.com/partners/list?categories=SOLUTIONING\&ref=docs-migrate-crm) para mover tus datos, pipelines y usuarios de principio a fin.
  * **Paquete de incorporación:** una configuración guiada de 4 horas con nuestro equipo — [contact@arxena.com](mailto:contact@arxena.com).
</Tip>
