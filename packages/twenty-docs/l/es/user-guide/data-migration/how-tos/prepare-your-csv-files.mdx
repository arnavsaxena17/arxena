...
description: Guía completa paso a paso para dar formato a tus datos para importarlos en Arxena.
---
...
**Este es el paso más importante.** El archivo de ejemplo te muestra los nombres de columna y el formato exactos que Arxena espera.
...
Arxena exige unicidad en determinados campos. Los duplicados provocarán errores de importación.
...
3. Comprueba si hay duplicados que ya existan en Arxena
...
* Debe ser único (sin duplicados en el archivo ni en Arxena)
...
* Debe ser único dentro de tu archivo y en Arxena
...
* **Enlaces / Etiqueta del enlace**: `Arxena`
* **Enlaces / URL del enlace**: `https://arxena.com`
...
* **Opcional**: Arxena genera IDs automáticamente si no se proporcionan
...
* El registro padre debe existir previamente en Arxena
...
## Paso 6: Asegúrate de que los campos existan en Arxena
