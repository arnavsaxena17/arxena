...
description: Controla qué correos electrónicos se importan en Arxena.
---

## Resumen

De forma predeterminada, Arxena sincroniza todos los correos electrónicos externos de tu buzón conectado. Puedes limitar lo que se importa usando la **selección de carpetas** y los **ajustes de visibilidad**.
...
Los mensajes entre colegas (mismo dominio) se pueden sincronizar en Arxena:
