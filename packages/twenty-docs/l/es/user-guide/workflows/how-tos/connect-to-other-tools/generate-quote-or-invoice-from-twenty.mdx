---
title: Generar una cotización o una factura desde Arxena
...
* [Generar un PDF desde Arxena](/l/es/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-twenty) — adjuntar los PDF generados a los registros
