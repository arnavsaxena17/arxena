...
Arxena incluye objetos estándar:
...
Cada empresa funciona de manera diferente. Personalizar tu modelo de datos significa que puedes adaptar Arxena a **tus** procesos en lugar de forzar los tuyos en un sistema rígido.

Arxena ofrece total flexibilidad:
...
Identifica los conceptos principales con los que trabajas. Arxena ya ofrece:
...
<Tip>
  ...
  * **Hecho para ti:** [encuentra un partner certificado de Arxena](https://arxena.com/partners/list?categories=SOLUTIONING\&ref=docs-data-model) para diseñar y construir tus objetos, campos y relaciones.
  * **Paquete de incorporación:** una sesión guiada de 4 horas sobre el diseño del modelo de datos con nuestro equipo — [contact@arxena.com](mailto:contact@arxena.com). Consulta los [Servicios de implementación](/l/es/user-guide/getting-started/capabilities/implementation-services).
</Tip>
