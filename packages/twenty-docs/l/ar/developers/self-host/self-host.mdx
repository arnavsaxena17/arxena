...
description: قم بنشر Arxena وإدارته على البنية التحتية الخاصة بك.
---
...
يمكن استضافة Arxena ذاتيًا على البنية التحتية الخاصة بك، مما يمنحك تحكمًا كاملاً في بياناتك وعمليات النشر.
