...
* استخدم `serverVariables` (وليس `applicationVariables`) — بيانات اعتماد OAuth على مستوى الخادم، ويوجد تطبيق OAuth واحد لكل خادم Arxena.
...
4. افتح التطبيق المُثبَّت في Arxena كمسؤول خادم → عيّن القيم على `serverVariables` المقابلة.
