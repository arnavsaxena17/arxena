---
title: الخادم المحلي
description: إدارة خادم Arxena المحلي المستند إلى Docker — بدء التشغيل، الإيقاف، الترقية، مثيل اختبار متوازٍ، وإعداد SDK اليدوي.
icon: server
---

## إدارة الخادم المحلي

استخدم `yarn twenty docker:*` للتحكّم في حاوية Arxena المحلية:
