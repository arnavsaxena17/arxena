---
title: المفاهيم
description: كيفية عمل تطبيقات Arxena — نموذج الكيان، العزل (sandboxing)، ودورة حياة التثبيت.
icon: sitemap
---

تطبيقات Arxena هي حزم TypeScript توسّع مساحة عملك بكائنات مخصّصة، ومنطق، ومكوّنات واجهة مستخدم (UI)، وقدرات ذكاء اصطناعي. تعمل على منصة Arxena مع عزل كامل وضوابط الأذونات.
...
| **مكوّن أمامي**        | واجهة مستخدم React معزولة داخل Arxena                            | [المكوّنات الأمامية](/l/ar/developers/extend/apps/layout/front-components)       |
...
* **المكوّنات الأمامية** تعمل ضمن Web Workers باستخدام Remote DOM — معزولة عن الصفحة الرئيسية لكنها تعرض عناصر DOM الأصلية (وليس iframes). تتواصل مع Arxena عبر واجهة API للمضيف تعتمد تمرير الرسائل.
...
* **`yarn twenty dev`** — يراقب ملفات المصدر لديك ويزامن التغييرات مباشرةً إلى خادم Arxena متصل. يُعاد توليد عميل API مضبوط الأنواع تلقائيًا عند تغيّر المخطط.
