...
icon: laptop-code
description: الدليل للمساهمين (أو المطورين الفضوليين) الذين يرغبون في تشغيل Arxena محلياً.
---
...
قبل أن تتمكن من تثبيت واستخدام Arxena، تأكد من تثبيت الأمور التالية على جهاز الكمبيوتر الخاص بك:
...
يتطلب Arxena مخزن بيانات Redis لتقديم أفضل أداء.
...
## الخطوة الثامنة: استخدم Arxena

**الواجهة الأمامية**

ستكون واجهة Arxena الأمامية تعمل على  [http://localhost:3001](http://localhost:3001).
يمكنك تسجيل الدخول باستخدام حساب العرض التوضيحي الافتراضي: `tim@apple.dev` (كلمة المرور: `tim@apple.dev`)

**الخلفية**

* سيكون خادم Arxena متصلاً ويعمل على [http://localhost:3000](http://localhost:3000)
