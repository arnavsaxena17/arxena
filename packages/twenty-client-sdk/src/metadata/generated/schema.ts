...
export type PermissionFlagType = 'API_KEYS_AND_WEBHOOKS' | 'WORKSPACE' | 'WORKSPACE_MEMBERS' | 'ROLES' | 'DATA_MODEL' | 'SECURITY' | 'WORKFLOWS' | 'IMPERSONATE' | 'SSO_BYPASS' | 'APPLICATIONS' | 'MARKETPLACE_APPS' | 'LAYOUTS' | 'BILLING' | 'AI_SETTINGS' | 'AI' | 'VIEWS' | 'UPLOAD_FILE' | 'DOWNLOAD_FILE' | 'SEND_EMAIL_TOOL' | 'CREATE_CALENDAR_EVENT_TOOL' | 'HTTP_REQUEST_TOOL' | 'CODE_INTERPRETER_TOOL' | 'SEND_FILES_TOOL' | 'IMPORT_CSV' | 'EXPORT_CSV' | 'CONNECTED_ACCOUNTS' | 'PROFILE_INFORMATION'
...
export const enumEngineComponentKey = {
   ...
   BULK_FORCE_STOP_WORKFLOW_RUNS: 'BULK_FORCE_STOP_WORKFLOW_RUNS' as const,
...
export const enumPermissionFlagType = {
   ...
   SEND_FILES_TOOL: 'SEND_FILES_TOOL' as const,
...
export const enumFeatureFlagKey = {
   ...
   IS_ORG_CHART_GRADE_ALIGNED_LAYOUT_ENABLED: 'IS_ORG_CHART_GRADE_ALIGNED_LAYOUT_ENABLED' as const,
   ...
   IS_OUTREACH_MOCK_UNIPILE_ENABLED: 'IS_OUTREACH_MOCK_UNIPILE_ENABLED' as const
}
