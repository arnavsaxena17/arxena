...
export const SEARCH_PEOPLE_BY_JOB_TITLE_INPUT_DESCRIPTOR: readonly McpInputFieldDescriptor[] = [
  { key: 'jobTitle', type: 'string', description: 'Role utterance or title (e.g. "CEO at StayVista", "Head of Marketing"). Alias of search_people_api.naturalLanguage.', required: true },
  ...
  { key: 'limit', type: 'number', description: 'Maximum results (default 20, max 500). Unipile paginates at up to 100 per page.', required: false },
] as const;
...
export const SEARCH_PEOPLE_API_INPUT_DESCRIPTOR: readonly McpInputFieldDescriptor[] = [
  ...
  { key: 'personName', type: 'string', description: 'Person name filter', required: false },
  { key: 'jobTitle', type: 'string', description: 'Literal job title keyword (not classified; prefer naturalLanguage)', required: false },
  { key: 'companyId', type: 'string', description: 'Company slug/id filter', required: false },
  { key: 'companyName', type: 'string', description: 'Company name filter. Required if naturalLanguage has no company.', required: false },
  { key: 'website', type: 'string', description: 'Company website filter', required: false },
  { key: 'stdFunction', type: 'string', description: 'Standardized function child label (e.g. software engineering). Must match GET /people-api/taxonomy/tree.', required: false },
  { key: 'stdGrade', type: 'string', description: 'Standardized grade: entry, mid, or leadership', required: false },
  { key: 'country', type: 'string', description: 'Location country filter', required: false },
