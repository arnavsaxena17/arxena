...
import { VIDEO_INTERVIEW_TEMPLATE_OBJECT_UNIVERSAL_IDENTIFIER } from 'src/constants/legacy-identifiers';
...
export default defineNavigationMenuItem({
  ...
  position: 1,
  targetObjectUniversalIdentifier: VIDEO_INTERVIEW_TEMPLATE_OBJECT_UNIVERSAL_IDENTIFIER,
});
