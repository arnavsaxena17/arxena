...
import { VIDEO_INTERVIEW_MODEL_OBJECT_UNIVERSAL_IDENTIFIER } from 'src/constants/legacy-identifiers';
...
export default defineNavigationMenuItem({
  ...
  position: 0,
  targetObjectUniversalIdentifier: VIDEO_INTERVIEW_MODEL_OBJECT_UNIVERSAL_IDENTIFIER,
});
