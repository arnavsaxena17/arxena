...
import { VIDEO_INTERVIEW_QUESTION_OBJECT_UNIVERSAL_IDENTIFIER } from 'src/constants/legacy-identifiers';
...
export default defineNavigationMenuItem({
  ...
  position: 2,
  targetObjectUniversalIdentifier: VIDEO_INTERVIEW_QUESTION_OBJECT_UNIVERSAL_IDENTIFIER,
});
