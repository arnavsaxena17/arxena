...
import { SCREENING_OBJECT_UNIVERSAL_IDENTIFIER } from 'src/constants/legacy-identifiers';
...
export default defineNavigationMenuItem({
  ...
  position: 2,
  targetObjectUniversalIdentifier: SCREENING_OBJECT_UNIVERSAL_IDENTIFIER,
});
