...
import { PRIVACY_CONSENT_COOKIE_NAME } from 'twenty-shared/constants';
import { parsePrivacyConsentCookieValue } from 'twenty-shared/utils';
...
export default async function RootLayout({
  ...
  const initialConsent = parsePrivacyConsentCookieValue(
    cookieStore.get(PRIVACY_CONSENT_COOKIE_NAME)?.value,
  );
