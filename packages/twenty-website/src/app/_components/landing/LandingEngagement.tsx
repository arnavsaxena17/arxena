        ...
        <StyledDemoPanel onClick={(e) => e.stopPropagation()}>
          <StyledChatColumn>
            <StyledWaHeader>
              ...
              <StyledWaHeaderTitle>Arnav Saxena</StyledWaHeaderTitle>
              <StyledWaHeaderSub>
                Head of Corporate Strategy, Acme Corporation
              </StyledWaHeaderSub>
            </StyledWaHeader>
            <StyledWaChatArea>
              {SAMPLE_CHAT.map((msg, i) => {
                ...
                return (
                  <StyledWaBubble key={i} isBot={isBot}>
                    {hasAttachment ? (
                      <>
                        <StyledWaAttachment isBot={isBot}>
                          <StyledWaAttachmentIcon isBot={isBot}>
                            📄
                          </StyledWaAttachmentIcon>
                          <StyledWaAttachmentInfo>
                            <StyledWaAttachmentFilename isBot={isBot}>
                              {msg.attachment.filename}
                            </StyledWaAttachmentFilename>
                            {msg.attachment.size && (
                              <StyledWaAttachmentSize isBot={isBot}>
                                {msg.attachment.size}
                              </StyledWaAttachmentSize>
                            )}
                          </StyledWaAttachmentInfo>
                        </StyledWaAttachment>
                        <StyledWaBubbleTime isBot={isBot}>
                          {msg.time}
                        </StyledWaBubbleTime>
                      </>
                    ) : (
