...
Do NOT use this for native GTM workflow actions (search-people-for-company, search-people, search-companies, search-jobs, search-posts, fetch-linkedin-profile, fetch-linkedin-messages, fetch-company-details) — source is a typed contract only. Use list_logic_function_tools inputSchema instead.`,
