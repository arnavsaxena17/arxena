...
import { isWorkflowFollowLinkedinProfileAction } from 'src/modules/workflow/workflow-executor/workflow-actions/unipile-messaging/guards/is-workflow-follow-linkedin-profile-action.guard';
...
import { type WorkflowFollowLinkedinProfileActionInput } from 'src/modules/workflow/workflow-executor/workflow-actions/unipile-messaging/types/workflow-follow-linkedin-profile-action-input.type';
...
@Injectable()
export class FollowLinkedinProfileWorkflowAction extends UnipileMessagingWorkflowActionBase<WorkflowFollowLinkedinProfileActionInput> {
  constructor(
    private readonly followLinkedinProfileTool: FollowLinkedinProfileTool,
    ...
    super(
      FollowLinkedinProfileWorkflowAction.name,
  ...
  protected getTool(): Tool {
    return this.followLinkedinProfileTool;
  }
  ...
  protected assertStep(step: WorkflowAction): void {
    if (!isWorkflowFollowLinkedinProfileAction(step)) {
      throw new WorkflowStepExecutorException(
        'Step is not a follow-linkedin-profile action',
