...
import { WorkspaceModificationsCommandModule } from 'src/engine/core-modules/workspace-modifications/commands/workspace-modifications-command.module';
...
@Module({
  imports: [
    ...
    WorkspaceModificationsCommandModule,
