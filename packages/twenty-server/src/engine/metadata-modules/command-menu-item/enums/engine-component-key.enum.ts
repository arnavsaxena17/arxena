...
export enum EngineComponentKey {
  ...
  BULK_FORCE_STOP_WORKFLOW_RUNS = 'BULK_FORCE_STOP_WORKFLOW_RUNS',
  ...
  // ARX record-selection actions (ported from workflows action-menu)
  ARX_CLONE_MULTIPLE_RECORDS = 'ARX_CLONE_MULTIPLE_RECORDS',
  ARX_CREATE_VINT_LINK = 'ARX_CREATE_VINT_LINK',
  ARX_SHARE_VINT_LINK = 'ARX_SHARE_VINT_LINK',
  ARX_START_CHAT_WITH_CANDIDATES = 'ARX_START_CHAT_WITH_CANDIDATES',
  ARX_STOP_CHAT_WITH_CANDIDATES = 'ARX_STOP_CHAT_WITH_CANDIDATES',
  ARX_START_OUTREACH = 'ARX_START_OUTREACH',
  ARX_STOP_OUTREACH = 'ARX_STOP_OUTREACH',
  ARX_UPDATE_MESSAGING_CHANNEL_FOR_CANDIDATES = 'ARX_UPDATE_MESSAGING_CHANNEL_FOR_CANDIDATES',
  ARX_MOVE_CANDIDATES_TO_ANOTHER_PROJECT = 'ARX_MOVE_CANDIDATES_TO_ANOTHER_PROJECT',
  ARX_REFRESH_CHAT_STATUS = 'ARX_REFRESH_CHAT_STATUS',
  ARX_REFRESH_CHAT_COUNT = 'ARX_REFRESH_CHAT_COUNT',
  ARX_POPULATE_SHORTLIST = 'ARX_POPULATE_SHORTLIST',
  ARX_SHARE_CHAT_BASED_SHORTLIST = 'ARX_SHARE_CHAT_BASED_SHORTLIST',
  ARX_UPDATE_SNAPSHOT_PROFILES_FROM_JOB_BOARDS = 'ARX_UPDATE_SNAPSHOT_PROFILES_FROM_JOB_BOARDS',
  ARX_CHAT_AND_VIDEO_INTERVIEW_SHORTLIST = 'ARX_CHAT_AND_VIDEO_INTERVIEW_SHORTLIST',
  ARX_DOWNLOAD_SHORTLIST = 'ARX_DOWNLOAD_SHORTLIST',
  ARX_SEND_TO_WHATSAPP = 'ARX_SEND_TO_WHATSAPP',
  ARX_DELETE_CANDIDATES_AND_PEOPLE = 'ARX_DELETE_CANDIDATES_AND_PEOPLE',
  ARX_DOWNLOAD_CANDIDATE_CVS = 'ARX_DOWNLOAD_CANDIDATE_CVS',
  ARX_ADD_TO_GOOGLE_CONTACTS = 'ARX_ADD_TO_GOOGLE_CONTACTS',
  ARX_RESTART_MSGS = 'ARX_RESTART_MSGS',
  ARX_RESET_MSGS_FROM_WHATSAPP = 'ARX_RESET_MSGS_FROM_WHATSAPP',
  ARX_SYNC_CHATS_WITH_WHATSAPP = 'ARX_SYNC_CHATS_WITH_WHATSAPP',
  ARX_DOWNLOAD_AS_EXCEL = 'ARX_DOWNLOAD_AS_EXCEL',
  ARX_CHECK_CONTACT_AVAILABILITY = 'ARX_CHECK_CONTACT_AVAILABILITY',
  ARX_FETCH_CONTACT_DETAILS = 'ARX_FETCH_CONTACT_DETAILS',
  ARX_FETCH_EMAIL = 'ARX_FETCH_EMAIL',
  ARX_FETCH_PHONE = 'ARX_FETCH_PHONE',
  ARX_CREATE_INTERVIEWER_AVATAR_VIDEOS = 'ARX_CREATE_INTERVIEWER_AVATAR_VIDEOS',
  ARX_CHECK_DATA_INTEGRITY_OF_PROJECT = 'ARX_CHECK_DATA_INTEGRITY_OF_PROJECT',
  ARX_TRANSCRIBE_CALL = 'ARX_TRANSCRIBE_CALL',
  ARX_QUALIFY_PROSPECT = 'ARX_QUALIFY_PROSPECT',
  ARX_FETCH_LINKEDIN_MESSAGES = 'ARX_FETCH_LINKEDIN_MESSAGES',
  ARX_FETCH_LINKEDIN_POSTS = 'ARX_FETCH_LINKEDIN_POSTS',
  ARX_FETCH_LINKEDIN_PROFILE = 'ARX_FETCH_LINKEDIN_PROFILE',
