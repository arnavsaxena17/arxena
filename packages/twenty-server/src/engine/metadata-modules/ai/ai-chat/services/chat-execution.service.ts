...
export class ChatExecutionService {
  ...
  private buildOutreachCommandContext(
    ...
    return [
      ...
      '2. Prefer Project outreachWorkflowId / name "Outreach — Per Enrolled Candidate"; clone via create_draft_from_workflow_version before editing; do not rebuild from scratch',
