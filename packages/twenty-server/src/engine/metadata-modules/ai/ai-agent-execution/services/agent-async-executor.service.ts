...
import { WORKFLOW_AGENT_EXCLUDED_TOOL_NAMES } from 'src/engine/metadata-modules/ai/ai-agent-execution/constants/workflow-agent-excluded-tool-names.constant';
        ...
        if (isDefined(agentRoleId)) {
          ...
          registryTools = await this.toolRegistry.getToolsByCategories(
            toolProviderContext,
            {
              ...
              excludeTools: [...WORKFLOW_AGENT_EXCLUDED_TOOL_NAMES],
