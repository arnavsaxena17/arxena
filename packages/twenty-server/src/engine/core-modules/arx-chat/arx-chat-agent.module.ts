...
import { ArxChatEndpoint, UpdateChatEndpoint, WhatsappControllers, WhatsappWebhook } from 'src/engine/core-modules/arx-chat/arx-chat-agent.controller';
...
@Module({
  ...
  controllers: [ArxChatEndpoint, UpdateChatEndpoint, WhatsappWebhook, WhatsappControllers],
