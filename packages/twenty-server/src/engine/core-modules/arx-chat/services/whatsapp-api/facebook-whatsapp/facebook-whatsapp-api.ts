...
export class FacebookWhatsappChatApi {
  ...
  async fetchFileFromTwentyGetLocalPath() {
    const fileUrl =
      ...
      '/files/attachment/2604e253-36e3-4e87-9638-bdbb661a0547.pdf?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHBpcmF0aW9uX2RhdGUiOiIyMDI0LTA1LTI3VDEwOjE3OjM5Ljk2MFoiLCJhdHRhY2htZW50X2lkIjoiZjIwYjE5YzUtZDAwYy00NzBjLWI5YjAtNzY2MTgwOTdhZjkyIiwiaWF0IjoxNzE2NzE4NjU5LCJleHAiOjE3MTY4OTg2NTl9.NP6CvbDKTh3W0T0uP0JKUfnV_PmN6rIz6FanK7Hp_us';
  ...
  async uploadFileToWhatsAppUsingControllerApi(filePathArg: string, apiToken: string) {
    ...
    try {
      ...
      formData.append('messaging_product', 'whatsapp');
      try {
        const { data: { id: mediaId }, } = await axios.post(`https://graph.facebook.com/v18.0/${FACEBOOK_WHATSAPP_PHONE_NUMBER_ID}/media`, formData, { headers: { Authorization: `Bearer ${whatsappAPIToken}`, ...formData.getHeaders(), }, });
