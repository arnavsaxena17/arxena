...
export class WhatsappTemplateMessages {
  ...
  getUpdatedUtilityMessageObj(
    sendTemplateMessageObj: SendWhatsappUtilityMessageObjectType,
  ) {
    ...
    switch (sendTemplateMessageObj.template_name) {
            ...
            components: [
              {
                ...
                parameters: [
                  ...
                  {
                    type: 'text',
                    text: sendTemplateMessageObj.videoInterviewLink,
                  },
            ...
            components: [
              {
                ...
                parameters: [
                  ...
                  {
                    type: 'text',
                    text: "believe that your profile won't be a good fit",
                  },
                ],
              },
            ],
            ...
            components: [
              {
                ...
                parameters: [
                  ...
                  {
                    type: 'text',
                    text: sendTemplateMessageObj.discussionDate || 'earlier',
                  },
                  {
                    type: 'text',
                    text: sendTemplateMessageObj.nextStep || 'next steps',
                  },
                  {
                    type: 'text',
                    text:
                      sendTemplateMessageObj.availableDate ||
                      'tomorrow for a quick chat?',
                  },
                  { type: 'text', text: sendTemplateMessageObj.recruiterName },
                ],
              },
      ...
      default:
        throw new Error(
          `Unknown template: ${sendTemplateMessageObj.template_name}`,
        );
    }
  ...
  private transformData(
    data: SendWhatsappUtilityMessageObjectType,
  ): Record<string, any> {
    const currentISTTime = new Date().toLocaleString('en-US', {
      timeZone: 'Asia/Kolkata',
    });
