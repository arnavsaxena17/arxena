  ...
  async sendWhatsappMessage(
    ...
    try {
      if (process.env.WHATSAPP_API === 'facebook') {
        await new FacebookWhatsappChatApi(this.workspaceQueryService).sendWhatsappMessageVIAFacebookAPI(whatappUpdateMessageObj, personNode, candidateJob, mostRecentMessageArr, chatControl, apiToken);
