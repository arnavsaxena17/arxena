...
} from "../../services/whatsapp-api/baileys/callBaileys";
...
export class WhatsappAPISelector {
  ...
  async sendWhatsappMessage(
    ...
    if (process.env.WHATSAPP_API === "facebook") {
      const response =
        await new FacebookWhatsappChatApi().sendWhatsappMessageVIAFacebookAPI(
  ...
  async sendJDViaWhatsapp(
    ...
    await new WhatsappAPISelector().sendAttachmentMessageOnWhatsapp(
