...
export async function shareJDtoCandidate(person:allDataObjects.PersonNode){
    console.log("shareJDtoCandidate function is being called")
    debugger;
    console.log("This is the person for which we are trying to send the JD:", person.candidates)
    ...
    const attachment = jobAttachments;
    console.log("attachment: what I'm passing to  sendJDViaWhatsapp:  ", attachment);
