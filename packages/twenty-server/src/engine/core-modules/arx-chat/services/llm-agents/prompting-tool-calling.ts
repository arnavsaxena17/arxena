...
export class ToolsForAgents{
  ...
  convertToBulletPoints (steps: { [x: string]: any; 1?: string; 2?: string; 3?: string; 4?: string; }){
    let result = "";
  ...
  async getSystemPromptBasedOnStage(personNode:allDataObjects.PersonNode, stage:string){
    ...
    console.log("This is the stage based system prompt, currently being sent by the system:", stage)
    return systemPrompt
  }
