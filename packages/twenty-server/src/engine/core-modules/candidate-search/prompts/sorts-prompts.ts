...
export class SortsPrompts {
  ...
  static getExamples(): Record<string, any> {
    return {
      multiColumnSort: {
        name: "Executive Quality Prioritization",
        description: "Prioritize candidates with strong technical skills, appropriate seniority, and cultural fit",
        reasoning: "For executive positions, we need to prioritize candidates who demonstrate strong technical competency, appropriate seniority level, and cultural alignment with the company.",
        sortColumns: [
          {
            column: "primarySkillsMatch",
            sortOrder: "desc",
            priority: 1,
            reasoning: "Primary skills match is the most critical factor for technical roles"
          },
          {
            column: "seniorityLevel",
            sortOrder: "desc", 
            priority: 2,
            reasoning: "Seniority level ensures candidates have appropriate experience for executive role"
          },
          {
            column: "managementExperience",
            sortOrder: "desc",
            priority: 3,
            reasoning: "Management experience is crucial for executive positions"
          },
          {
            column: "culturalFitScore",
            sortOrder: "desc",
            priority: 4,
            reasoning: "Cultural fit ensures long-term success and team alignment"
          },
          {
            column: "networkDistance",
            sortOrder: "asc",
            priority: 5,
            reasoning: "Closer network connections may indicate better cultural fit and easier onboarding"
          }
        ]
      },
      technicalFocusSort: {
        name: "Technical Excellence Focus",
        description: "Prioritize candidates with exceptional technical skills and relevant experience",
        reasoning: "For highly technical roles, prioritize candidates with strong technical backgrounds and relevant industry experience.",
        sortColumns: [
          {
            column: "technicalSkillsScore",
            sortOrder: "desc",
            priority: 1,
            reasoning: "Technical skills are paramount for this role"
          },
          {
            column: "industryExperience",
            sortOrder: "desc",
            priority: 2,
            reasoning: "Industry-specific experience provides valuable context"
          },
          {
            column: "yearsOfExperience",
            sortOrder: "desc",
            priority: 3,
            reasoning: "More experience typically correlates with better problem-solving abilities"
          },
          {
            column: "educationRelevance",
            sortOrder: "desc",
            priority: 4,
            reasoning: "Relevant education background supports technical competency"
          }
        ]
      },
      locationOptimizedSort: {
        name: "Location and Skills Balance",
        description: "Balance technical skills with location preferences and relocation potential",
        reasoning: "For roles requiring specific location or relocation, balance technical qualifications with location factors.",
        sortColumns: [
          {
            column: "skillsMatchScore",
            sortOrder: "desc",
            priority: 1,
            reasoning: "Skills match remains the primary qualification factor"
          },
          {
            column: "relocationWillingness",
            sortOrder: "desc",
            priority: 2,
            reasoning: "Relocation willingness is crucial for this position"
          },
          {
            column: "locationProximity",
            sortOrder: "asc",
            priority: 3,
            reasoning: "Closer candidates may have easier onboarding and cultural fit"
          },
          {
            column: "remoteWorkExperience",
            sortOrder: "desc",
            priority: 4,
            reasoning: "Remote work experience indicates adaptability"
          }
        ]
      }
    };
