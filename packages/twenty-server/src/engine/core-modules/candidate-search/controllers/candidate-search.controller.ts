...
import { ChatMessageRequest, ChatMessageResponse, GenerateEnrichmentsRequest, GenerateFiltersRequest, GenerateSortsRequest } from 'src/engine/core-modules/candidate-search/types/search-plan.types';
