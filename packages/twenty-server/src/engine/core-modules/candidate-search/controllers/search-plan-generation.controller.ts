...
export class SearchPlanGenerationController {
  ...
  //     const searchParameters = await this.searchPlanGenerationService.generateSearchParametersFromLLM(
  //       parsedJD,
  //       body.searchType,
  //       body.searchCategory,
  //       apiToken
  ...
  //     const chatMessage = 'Search parameters generated successfully';
  //     this.logger.log (`chatMessage from generate search parameters:: ${JSON.stringify(chatMessage, null, 2)}`);
