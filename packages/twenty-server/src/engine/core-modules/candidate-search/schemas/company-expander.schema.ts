...
export const companyListsSchema = z.object({
  ...
  all: z.array(z.string()).describe('All possible targetable company names, name variations included (e.g. PwC -> [PwC, PricewaterhouseCoopers]). Return as many as possible.'),
  // name_variations: z
