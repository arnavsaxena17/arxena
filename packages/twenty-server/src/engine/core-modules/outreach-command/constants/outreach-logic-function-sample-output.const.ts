...
export const OUTREACH_UPSERT_COMPANIES_SAMPLE_OUTPUT = {
  success: true,
  created: 1,
  updated: 0,
  skipped: 0,
...
export const OUTREACH_ENRICH_CONTACT_SAMPLE_OUTPUT = {
  success: true,
...
export const OUTREACH_FETCH_EMAIL_SAMPLE_OUTPUT = {
  success: true,
  email: 'arapahara@acme.com',
  emails: ['arapahara@acme.com'],
  phones: [],
...
export const OUTREACH_FETCH_PHONE_SAMPLE_OUTPUT = {
  success: true,
  email: '',
  emails: [],
  phones: ['+1-555-0100'],
