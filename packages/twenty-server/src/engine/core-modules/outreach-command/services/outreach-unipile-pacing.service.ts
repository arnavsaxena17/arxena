...
@Injectable()
export class OutreachUnipilePacingService {
  constructor(
    private readonly globalWorkspaceOrmManager: GlobalWorkspaceOrmManager,
    private readonly gtmOutreachThrottleService: OutreachThrottleService,
  ) {}
  ...
  }): Promise<OutreachThrottleCheckResult & { projectId: string | null }> {
  ...
  async stampSuccess({
    ...
    channel: OutreachThrottleChannel;
    patch: Partial<OutreachThrottleCounters>;
  }): Promise<void> {
