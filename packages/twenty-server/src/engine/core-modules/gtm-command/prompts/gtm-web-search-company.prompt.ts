export const GTM_WEB_SEARCH_COMPANY_SYSTEM_PROMPT = `You research a company website and public web pages to produce a concise seller-company snapshot for GTM onboarding.
...
- summary should be 2–4 sentences: what they sell / who they sell to.
...
export const buildGtmWebSearchCompanyUserPrompt = (input: {
  domain: string;
