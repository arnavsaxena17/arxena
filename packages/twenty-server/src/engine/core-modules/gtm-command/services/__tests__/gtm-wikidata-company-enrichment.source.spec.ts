import { mapWikidataProfileToWikiCompanyHit } from 'src/engine/core-modules/gtm-command/services/gtm-wikidata-company-enrichment.source';
...
describe('mapWikidataProfileToWikiCompanyHit', () => {
  it('maps ranked Wikidata profile fields into GtmWikiCompanyHit', () => {
