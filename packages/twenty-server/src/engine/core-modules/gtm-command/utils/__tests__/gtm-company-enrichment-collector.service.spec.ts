...
import type { GtmCompanyEnrichmentSource } from 'src/engine/core-modules/gtm-command/utils/gtm-company-enrichment-source.types';

describe('GtmCompanyEnrichmentCollectorService', () => {
  it('merges ordered source partials and passes prior hints', async () => {
    ...
    const apolloSource: GtmCompanyEnrichmentSource = {
      sourceId: 'apollo',
      enrich: async () => {
  ...
  it('keeps LinkedIn, Wikidata, and companies ES payloads as separate fields', async () => {
    ...
    const wikidataSource: GtmCompanyEnrichmentSource = {
      sourceId: 'wikidata',
      enrich: async () => ({
        sourceId: 'wikidata',
        wikidataCompany: {
    ...
    const indexWikiSource: GtmCompanyEnrichmentSource = {
      sourceId: 'companies_index_wiki',
      enrich: async () => ({
        sourceId: 'companies_index_wiki',
  ...
  it('merges web_search website snapshot from a later source', async () => {
    ...
    const webSearchSource: GtmCompanyEnrichmentSource = {
      sourceId: 'web_search',
      enrich: async (input) => ({
        sourceId: 'web_search',
        webSearchCompany: {
