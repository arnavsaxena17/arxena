import { classifyInboundReplyFallback } from 'src/engine/core-modules/gtm-command/utils/gtm-inbound-reply-classifier.util';

describe('gtm-inbound-reply-classifier.util', () => {
