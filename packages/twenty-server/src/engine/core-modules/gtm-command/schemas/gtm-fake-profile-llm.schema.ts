...
export type GtmFakeProfileVerdict = z.infer<typeof gtmFakeProfileVerdictSchema>;
export type GtmFakeProfileLlmResult = z.infer<
  typeof gtmFakeProfileLlmResultSchema
>;

export const isLikelyFakeVerdict = (verdict: GtmFakeProfileVerdict): boolean =>
