...
export const mapArxCandidateToCandidateNode = (candidate: {
  ...
  const candidateNode: ArxenaCandidateNode = {
    ...
    uniqueStringKey: candidate?.unique_key_string,
    hiringNaukriUrl: { "primaryLinkLabel": candidate?.profile_url.includes('hiring') ? candidate?.profile_url : '', "primaryLinkUrl": candidate?.profile_url.includes('hiring') ? candidate?.profile_url : '' },
    resdexNaukriUrl: { "primaryLinkLabel": candidate?.profile_url.includes('resdex') ? candidate?.profile_url : '', "primaryLinkUrl": candidate?.profile_url.includes('resdex') ? candidate?.profile_url : '' },
    displayPicture: { "primaryLinkLabel": "Display Picture", "primaryLinkUrl": candidate?.display_picture || '' },
    linkedinUrl: { "primaryLinkLabel": candidate?.profile_url.includes('linkedin') ? candidate?.profile_url : '', "primaryLinkUrl": candidate?.profile_url.includes('linkedin') ? candidate?.profile_url : '' },
    peopleId: '',
