// import { ChatRequestBody, candidateChatMessageType, recruiterProfile, sendWhatsappTemplateMessageObjectType } from "src/engine/core-modules/recruitment-agent/services/data-model-objects";
...
import { getContentTypeFromFileName } from "src/engine/core-modules/recruitment-agent/utils/recruitmentAgentUtils";
...
export class FacebookWhatsappChatApi {
  ...
  downloadWhatsappAttachmentMessage(sendTemplateMessageObj) {
    let config = {
      ...
      maxBodyLength: Infinity,
      url:
        "https://graph.facebook.com/v18.0/432131722836314/" +
        sendTemplateMessageObj.mediaId,
      headers: {
        Authorization: "Bearer " + whatsappAPIToken,
        "Content-Type": "application/json",
      },
