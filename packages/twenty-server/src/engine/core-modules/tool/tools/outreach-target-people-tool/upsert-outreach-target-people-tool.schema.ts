...
export const OutreachEphemeralPersonInputZodSchema = z.object({
  id: z
    .string()
    .optional()
    .describe(
  ...
  companyId: z
    ...
    .default('')
    .describe(
      'Optional ephemeral company id from Companies tab (not a CRM UUID).',
    ),
  companyName: z
    .string()
    .default('')
  ...
  stage: z
    ...
    .default('queued')
    .describe(
      'Display stage for the People tab before CRM enroll (default "queued")',
    ),
...
export const UpsertOutreachTargetPeopleInputZodSchema = z.object({
  projectId: z
    .string()
    .min(1)
    .describe(
  ...
  people: z
    .array(OutreachEphemeralPersonInputZodSchema)
    .min(1)
    .max(500)
    .describe('Target people to write to the ephemeral People tab'),
});

export type UpsertOutreachTargetPeopleInput = z.infer<
  typeof UpsertOutreachTargetPeopleInputZodSchema
>;
