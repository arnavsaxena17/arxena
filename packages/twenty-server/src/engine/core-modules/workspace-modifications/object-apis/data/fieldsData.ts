export function getFieldsData(
  ...
  // First validate that all required objects exist
  ...
  const missingObjects = requiredObjects.filter(obj => !objectsNameIdMap[obj]);
  
  if (missingObjects.length > 0) {
    console.error('Missing required objects:', missingObjects);
    console.log('Available objects:', Object.keys(objectsNameIdMap));
  }
