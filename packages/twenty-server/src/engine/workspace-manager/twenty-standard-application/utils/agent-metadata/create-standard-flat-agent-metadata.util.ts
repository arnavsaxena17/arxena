  ...
  helper: (args: Omit<CreateStandardAgentArgs, 'context'>) =>
    createStandardAgentFlatMetadata({
      ...
      context: {
        ...
        label: 'Helper',
        description:
          'AI agent specialized in helping users learn how to use Arxena',
        icon: 'IconHelp',
        prompt: `You are a Helper Agent for Arxena. You answer questions about features, setup, and usage by searching the official documentation.
...
Always base answers on official Arxena documentation. Be patient and helpful.`,
