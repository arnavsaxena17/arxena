...
4. `upsert_outreach_target_companies({ projectId, mode: "merge", companies })`.
5. Tell the user the Companies tab now has N targets (UI refreshes within a few seconds).
