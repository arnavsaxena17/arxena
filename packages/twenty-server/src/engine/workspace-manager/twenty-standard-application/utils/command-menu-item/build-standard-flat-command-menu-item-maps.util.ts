...
import { createStandardCommandMenuItemFlatMetadataFromDefinition } from 'src/engine/workspace-manager/twenty-standard-application/utils/command-menu-item/create-standard-command-menu-item-flat-metadata.util';
import { addFlatEntityToFlatEntityMapsThroughMutationOrThrow } from 'src/engine/workspace-manager/workspace-migration/utils/add-flat-entity-to-flat-entity-maps-through-mutation-or-throw.util';

const COMBINED_COMMAND_MENU_ITEMS = {
  ...STANDARD_COMMAND_MENU_ITEMS,
  ...ARXENA_STANDARD_COMMAND_MENU_ITEMS,
};

const COMBINED_COMMAND_MENU_ITEM_NAMES = Object.keys(
  COMBINED_COMMAND_MENU_ITEMS,
) as Array<keyof typeof COMBINED_COMMAND_MENU_ITEMS>;
...
export const buildStandardFlatCommandMenuItemMaps = ({
  ...
  for (const commandMenuItemName of COMBINED_COMMAND_MENU_ITEM_NAMES) {
    const flatCommandMenuItem =
      createStandardCommandMenuItemFlatMetadataFromDefinition({
        definition: COMBINED_COMMAND_MENU_ITEMS[commandMenuItemName],
