...
const getAllFieldsData = (
  ...
  const allFields: ArxenaFieldWithObject[] = [
    {
    ...
    },
    {
      ...
      field: {
        description:
          'Chat engagement booleans and last engagement control state',
        icon: 'IconFlag',
    ...
    },
    {
      ...
      field: {
        description:
          'Custom profile fields, chat answers, and AI enrichment data',
        label: 'Other fields',
        name: 'otherFields',
        objectMetadataId: objectsNameIdMap.candidate,
        type: 'RAW_JSON',
    ...
    },
    {
      ...
      field: {
        description:
          'Ordered chat questions asked during initial candidate engagement',
