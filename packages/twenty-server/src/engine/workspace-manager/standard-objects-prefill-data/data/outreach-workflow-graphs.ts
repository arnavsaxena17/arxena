...
const repliedBranchSteps = () => [
    ...
    extraFields: [
      {
        ...
        type: 'TEXT',
        label: 'Starts at (ISO)',
        value: `{{${IDS.validateSignals}.startsAt}}`,
      },
      {
        ...
        type: 'TEXT',
        label: 'Ends at (ISO)',
        value: `{{${IDS.validateSignals}.endsAt}}`,
      },
      {
        id: '55ab849c-4254-4381-a3f9-e63d956a36ae',
        name: 'prospectEmail',
        type: 'TEXT',
        label: 'Prospect email (details)',
        value: `{{${IDS.validateSignals}.prospectEmail}}`,
      },
      {
        id: '55ab849c-4254-4381-a3f9-e63d956a36af',
        name: 'emailSubject',
        type: 'TEXT',
        label: 'Email subject',
        value: `{{${IDS.draftReply}.emailSubject}}`,
      },
      {
        id: '55ab849c-4254-4381-a3f9-e63d956a36b0',
        name: 'emailBody',
        type: 'TEXT',
        label: 'Email body (details)',
        value: `{{${IDS.draftReply}.emailBody}}`,
      },
      {
        id: '55ab849c-4254-4381-a3f9-e63d956a36b1',
        name: 'referralName',
        type: 'TEXT',
        label: 'Referral name',
        value: `{{${IDS.validateSignals}.referralName}}`,
      },
      {
        id: '55ab849c-4254-4381-a3f9-e63d956a36b2',
        name: 'referralEmail',
        type: 'TEXT',
        label: 'Referral email',
        value: `{{${IDS.validateSignals}.referralEmail}}`,
      },
      {
        id: '55ab849c-4254-4381-a3f9-e63d956a36b3',
        name: 'referralPhone',
        type: 'TEXT',
        label: 'Referral WhatsApp / phone',
        value: `{{${IDS.validateSignals}.referralPhone}}`,
      },
      {
        id: '55ab849c-4254-4381-a3f9-e63d956a36b4',
        name: 'referralMessage',
        type: 'TEXT',
        label: 'Message to referral',
        value: `{{${IDS.draftReply}.referralMessage}}`,
      },
      {
        id: '55ab849c-4254-4381-a3f9-e63d956a36b5',
        name: 'replyChannel',
        type: 'TEXT',
        label: 'Reply channel (LINKEDIN / WHATSAPP / EMAIL)',
        value: `{{${IDS.validateSignals}.replyChannel}}`,
      },
    ],
    ...
    branches: [
      {
        ...
        stepOutputKey: `{{${IDS.approveReply}.replyChannel}}`,
        value: 'EMAIL',
        type: 'TEXT',
        operand: 'CONTAINS',
  ...
  gtmWfSendEmailStep({
    ...
    subject: `{{${IDS.approveReply}.emailSubject}}`,
  ...
  gtmWfIfElseStep({
    ...
    stepOutputKey: `{{${IDS.approveReply}.prospectEmail}}`,
    value: '',
    type: 'TEXT',
  ...
  gtmWfSendEmailStep({
    ...
    to: `{{${IDS.approveReply}.prospectEmail}}`,
    subject: `{{${IDS.approveReply}.emailSubject}}`,
    body: `{{${IDS.approveReply}.emailBody}}`,
  }),
  gtmWfMultiIfElseStep({
    ...
    branches: [
      {
        ...
        stepOutputKey: `{{${IDS.approveReply}.referralEmail}}`,
        value: '',
        type: 'TEXT',
        operand: 'IS_NOT_EMPTY',
      ...
      },
      {
        ...
        stepOutputKey: `{{${IDS.approveReply}.referralPhone}}`,
        value: '',
        type: 'TEXT',
        operand: 'IS_NOT_EMPTY',
        nextStepIds: [IDS.createReferral],
  ...
  }),
  {
    ...
    settings: {
      input: {
        objectName: 'candidate',
        objectRecord: {
          name: `{{${IDS.approveReply}.referralName}}`,
          ...
          email: {
            primaryEmail: `{{${IDS.approveReply}.referralEmail}}`,
          },
        },
      },
      outputSchema: {
  ...
  gtmWfSendEmailStep({
    ...
    to: `{{${IDS.approveReply}.referralEmail}}`,
    subject: `{{${IDS.approveReply}.emailSubject}}`,
    body: `{{${IDS.approveReply}.referralMessage}}`,
  }),
  gtmWfIfElseStep({
  ...
  gtmWfSendWhatsappMessageStep({
    ...
    phone: `{{${IDS.approveReply}.referralPhone}}`,
    body: `{{${IDS.approveReply}.referralMessage}}`,
  ...
  gtmWfIfElseStep({
    ...
    stepOutputKey: `{{${IDS.approveReply}.startsAt}}`,
    value: '',
    type: 'TEXT',
    operand: 'IS_NOT_EMPTY',
  ...
  }),
  {
    ...
    settings: {
      input: {
        title: 'Intro call',
        endsAt: `{{${IDS.approveReply}.endsAt}}`,
        location: '',
        startsAt: `{{${IDS.approveReply}.startsAt}}`,
        timeZone: '',
