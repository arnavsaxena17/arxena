import {
  buildGtmDeferredDraftPrompt,
  buildGtmMeetingBookedDetailsTemplate,
  buildGtmNegotiatingDraftPrompt,
  buildGtmRepliedDraftPrompt,
...
const candidateFind = (id: string, name: string, nextStepIds: string[]) =>
  gtmWfFindRecordsStep({
    ...
    fieldMetadataId: GTM_WF_FIELD.candidateId,
...
const companySiblingFilters = (
  extra: GtmWfFindRecordFilter[],
): GtmWfFindRecordFilter[] => [
  {
    fieldMetadataId: GTM_WF_FIELD.jobCompanyName,
  ...
  {
    fieldMetadataId: GTM_WF_FIELD.projectsId,
...
const followUpSteps = ({
  ...
  gtmWfAiAgentStep({
    ...
    agentId: GTM_WF_AGENT_LINKEDIN,
    outputSchema: GTM_WF_AI_MESSAGE_OUTPUT,
...
export const GTM_OUTREACH_WORKFLOW_GRAPH_TEMPLATES: Array<{
  name: string;
    ...
    steps: [
      ...
      gtmWfLogicFunctionStep({
        ...
        logicFunctionInput: {
          ...
          projectId: GTM_WF_HARVEST_PROJECT_ID,
        },
  ...
  },
  {
    ...
    trigger: gtmWfDatabaseEventTrigger({
      ...
      nextStepIds: [GTM_WF_MEMBER_STEP_ID],
    }),
    steps: [
      ...
      gtmWfFindRecordsStep({
        ...
        fieldMetadataId: GTM_WF_FIELD.chatCandidateId,
      ...
      gtmWfFormStep({
        ...
        detailsTemplate: buildGtmMeetingBookedDetailsTemplate({
      ...
      gtmWfAiAgentStep({
        id: IDS.draftReply,
        name: 'Draft reply',
        prompt: buildGtmRepliedDraftPrompt({
      ...
      gtmWfAiAgentStep({
        ...
        prompt: buildGtmNegotiatingDraftPrompt({
      ...
      gtmWfAiAgentStep({
        ...
        prompt: buildGtmDeferredDraftPrompt({
    ...
    steps: [
      ...
      gtmWfFindRecordsStep({
        ...
        filters: companySiblingFilters([
          ...
          {
            fieldMetadataId: GTM_WF_FIELD.createdAt,
      ...
      gtmWfAiAgentStep({
        ...
        agentId: GTM_WF_AGENT_EMAIL,
        outputSchema: GTM_WF_AI_EMAIL_OUTPUT,
