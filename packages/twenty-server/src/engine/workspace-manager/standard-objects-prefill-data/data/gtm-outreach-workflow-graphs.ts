...
export const GTM_OUTREACH_WORKFLOW_GRAPH_TEMPLATES: Array<{
  ...
  {
    name: 'GTM Outreach — Connection Accepted',
    trigger: gtmWfDatabaseEventTrigger({
      name: 'Candidate is Updated',
      eventName: 'candidate.updated',
      nextStepIds: [IDS.acceptFilter],
    }),
    steps: [
      gtmWfFilterStep({
        id: IDS.acceptFilter,
      ...
      candidateFind(IDS.acceptFind, 'Load Candidate', [GTM_WF_MEMBER_STEP_ID]),
      ...gtmWfMemberAndProfileSteps([IDS.fetchMessages]),
      gtmWfLogicFunctionStep({
  ...
  {
    name: 'GTM Outreach — Meeting Booked',
    trigger: gtmWfDatabaseEventTrigger({
      name: 'Candidate is Updated',
      eventName: 'candidate.updated',
      nextStepIds: [IDS.meetingFilter],
    }),
    steps: [
      gtmWfFilterStep({
        id: IDS.meetingFilter,
        name: 'Only MEETING_BOOKED',
        stepOutputKey: gtmWfTriggerAfter('outreachSequenceStage'),
        value: 'MEETING_BOOKED',
        nextStepIds: [IDS.meetingFind],
      }),
      candidateFind(IDS.meetingFind, 'Load Candidate', [GTM_WF_MEMBER_STEP_ID]),
      ...gtmWfMemberAndProfileSteps([IDS.meetingChats]),
      gtmWfFindRecordsStep({
        id: IDS.meetingChats,
  ...
  },
  {
    ...
    trigger: gtmWfDatabaseEventTrigger({
      name: 'Candidate is Updated',
      eventName: 'candidate.updated',
      nextStepIds: [IDS.repliedFilter],
    }),
    steps: [
      gtmWfFilterStep({
        id: IDS.repliedFilter,
        name: 'Only REPLIED candidates',
        stepOutputKey: gtmWfTriggerAfter('outreachSequenceStage'),
        value: 'REPLIED',
        nextStepIds: [IDS.repliedFind],
      }),
      candidateFind(IDS.repliedFind, 'Load Candidate', [GTM_WF_MEMBER_STEP_ID]),
      ...gtmWfMemberAndProfileSteps([IDS.findChats]),
      gtmWfFindRecordsStep({
        id: IDS.findChats,
  ...
  {
    name: 'GTM Outreach — Negotiating',
    trigger: gtmWfDatabaseEventTrigger({
      name: 'Candidate is Updated',
      eventName: 'candidate.updated',
      nextStepIds: [IDS.negotiatingFilter],
    }),
    steps: [
      gtmWfFilterStep({
        id: IDS.negotiatingFilter,
        name: 'Only NEGOTIATING candidates',
        stepOutputKey: gtmWfTriggerAfter('outreachSequenceStage'),
        value: 'NEGOTIATING',
      ...
      ...gtmWfMemberAndProfileSteps([IDS.negotiatingChats]),
      gtmWfFindRecordsStep({
  ...
  {
    name: 'GTM Outreach — Deferred',
    trigger: gtmWfDatabaseEventTrigger({
      name: 'Candidate is Updated',
      eventName: 'candidate.updated',
      nextStepIds: [IDS.deferredFilter],
    }),
    steps: [
      gtmWfFilterStep({
        id: IDS.deferredFilter,
        name: 'Only DEFERRED candidates',
        stepOutputKey: gtmWfTriggerAfter('outreachSequenceStage'),
        value: 'DEFERRED',
        nextStepIds: [IDS.deferredFind],
      }),
      candidateFind(IDS.deferredFind, 'Load Candidate', [GTM_WF_MEMBER_STEP_ID]),
      ...gtmWfMemberAndProfileSteps([IDS.deferredChats]),
      gtmWfFindRecordsStep({
