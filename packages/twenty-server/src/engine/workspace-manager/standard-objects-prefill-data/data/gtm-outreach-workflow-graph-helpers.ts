...
export const GTM_WF_ERROR_HANDLING = {
...
export const GTM_WF_AGENT_REPLY = '__AGENT_reply__';

export const GTM_WF_HARVEST_PROJECT_ID = '__PROJECT_GTM_HARVEST__';

export const GTM_WF_FIELD = {
...
export const GTM_WF_AI_EMAIL_OUTPUT = {
  subject: {
    isLeaf: true,
    type: 'string',
    label: 'subject',
...
export const GTM_WF_AI_REPLY_OUTPUT = {
  message: {
    isLeaf: true,
    type: 'string',
    label: 'message',
...
export const gtmWfProfileEmail = () =>
  v(GTM_WF_PROFILE_STEP_ID, 'first.email');
