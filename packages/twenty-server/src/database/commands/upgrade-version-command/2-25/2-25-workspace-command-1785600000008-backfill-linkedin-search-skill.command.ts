...
@RegisteredWorkspaceCommand('2.25.0', 1785600000008)
@Command({
  name: 'upgrade:2-25:backfill-linkedin-search-skill',
  description:
    'Backfill missing standard skills (including linkedin-search) for existing workspaces',
})
export class BackfillLinkedinSearchSkillCommand extends ProvisionedWorkspaceCommandRunner {
  constructor(
