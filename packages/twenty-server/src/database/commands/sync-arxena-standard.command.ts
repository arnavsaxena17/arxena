...
@Command({
  ...
  description:
    'Re-sync the Arxena standard application (objects + fields) onto provisioned workspaces. Required after Arxena object/field changes and before GTM Command dashboard seeding on existing workspaces.',
})
