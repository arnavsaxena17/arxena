...
@Command({
  ...
  description:
    'Re-sync the Arxena standard application (objects + fields) onto provisioned workspaces. Required before GTM Command dashboard seeding on existing workspaces.',
})
