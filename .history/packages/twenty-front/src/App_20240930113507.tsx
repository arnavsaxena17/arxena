...
import { RealTimeVideoInterviewResponsePage } from '@/ai-interview/interview-response/realtime';
  ...
  createBrowserRouter(
    createRoutesFromElements(
      <Route
        ...
        <Route path={AppPath.VideoInterview} element={<RealTimeVideoInterviewResponsePage />} />
      </Route>,
    ),
  );
